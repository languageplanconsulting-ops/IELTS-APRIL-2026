...
const CAM10_SECTION2_LEISURE_CLUB_SCRIPT = `Our greatest asset is probably our swimming pool which at 25 metres is not Olympic-sized, but now we have expanded it to eight lanes, it is much wider. This means there are rarely more than a couple of people at a time in each lane. Unfortunately, there is not space for an outdoor pool here, but the glass roof on the swimming pool is partly retractable, which means you can enjoy something of the open-air experience on warmer days.
Our recently refurbished fitness suite has all the latest exercise equipment including ten new running machines, and a wide range of weight-training machines. You are asked to fill in a questionnaire giving details of any health problems. One of our personal trainers will then go through this with you. The trainer will then take you through the safety rules for using the equipment in the fitness suite. At the end of the personal assessment, the trainer will draw up a plan, outlining what you should try to achieve within a six-week period.
All members must pay a joining fee of ninety pounds in addition to the rates for the monthly membership fees. Gold membership entitles you to free entry at all LP Clubs. LP gives booking preferences to Premier members at peak times. Premier membership is for individuals only, but you will be sent passes for guests every month. It is very important to remember your photo card because you will not be able to get in without it.`
...
export const LISTENING_FOUNDATION_SETS: ListeningFoundationSet[] = [
  {
    ...
    questions: [
      ...
      q(2, 13, 'New members should describe any _____.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'details of any health problems', 'B', [{ key: 'A', text: 'sports injuries' }, { key: 'B', text: 'health problems' }, { key: 'C', text: 'training goals' }, { key: 'D', text: 'work commitments' }], 'health problems', 'describe any', 'ปัญหาสุขภาพ', 'Giving details of health problems means describing any health problems.'),
      q(2, 14, 'The _____ will be explained before you use the equipment.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'safety rules for using the equipment', 'A', [{ key: 'A', text: 'safety rules' }, { key: 'B', text: 'monthly fees' }, { key: 'C', text: 'exercise plan' }, { key: 'D', text: 'booking system' }], 'take you through', 'will be explained', 'อธิบายให้เข้าใจ', 'Take you through means explain step by step.'),
      q(2, 15, 'You will be given a six-week _____.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'draw up a plan', 'C', [{ key: 'A', text: 'assessment' }, { key: 'B', text: 'questionnaire' }, { key: 'C', text: 'plan' }, { key: 'D', text: 'membership' }], 'draw up a plan', 'given a plan', 'จัดทำแผนให้', 'Draw up a plan means create or prepare a plan.'),
      q(2, 16, 'There is a compulsory 90 pound _____ fee.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'joining fee of ninety pounds', 'D', [{ key: 'A', text: 'monthly' }, { key: 'B', text: 'booking' }, { key: 'C', text: 'guest' }, { key: 'D', text: 'joining' }], 'must pay', 'compulsory fee', 'ค่าธรรมเนียมบังคับ', 'Must pay shows the fee is compulsory.'),
      q(2, 17, 'Gold members are given _____ to all LP clubs.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'free entry at all LP Clubs', 'A', [{ key: 'A', text: 'free entry' }, { key: 'B', text: 'priority booking' }, { key: 'C', text: 'guest passes' }, { key: 'D', text: 'robes' }], 'entitles you to', 'are given', 'ได้รับสิทธิ์', 'Entitles you to means gives you the right to have something.'),
      q(2, 18, 'Premier members are given priority during _____ hours.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'booking preferences to Premier members at peak times', 'C', [{ key: 'A', text: 'adult-only' }, { key: 'B', text: 'weekend' }, { key: 'C', text: 'peak' }, { key: 'D', text: 'monthly' }], 'peak times', 'priority hours', 'ช่วงเวลาที่คนใช้บริการมาก', 'Peak times are the busy hours, and booking preferences means priority.'),
      q(2, 19, 'Premier members can bring some _____ every month.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'passes for guests every month', 'B', [{ key: 'A', text: 'partners' }, { key: 'B', text: 'guests' }, { key: 'C', text: 'children' }, { key: 'D', text: 'trainers' }], 'guests', 'bring some guests', 'แขก / ผู้ติดตาม', 'Passes for guests means members can bring guests.'),
      q(2, 20, 'Members should always take their _____ with them.', CAM10_SECTION2_LEISURE_CLUB_SCRIPT, 'remember your photo card', 'D', [{ key: 'A', text: 'robe' }, { key: 'B', text: 'hairdryer' }, { key: 'C', text: 'questionnaire' }, { key: 'D', text: 'photo card' }], 'remember your photo card', 'always take', 'บัตรที่มีรูปถ่าย', 'Remember your photo card means always take it with you.')
    ]
  },
  {
