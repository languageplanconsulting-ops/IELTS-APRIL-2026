...
export const INTENSIVE_JOURNEY_FILL_BLANK_STAGES_1_5: NewFillBlankSet[] = [

  {
    ...
    questions: [
      ...
      { number: 10, answer: "4 sides", passageKeyword: "including descend bottom stunning", questionKeyword: "produce", thaiMeaning: "จากข้อความใน", exactPortion: "including four sides of steps that descend to the bottom in a stunning geometrical formation.", acceptedAnswers: ["4 sides", "Four sides", "four sides"] },
      ...
      { number: 12, answer: "verandahs", passageKeyword: "fourth verandas supported ornate", questionKeyword: "provide", thaiMeaning: "จากข้อความใน", exactPortion: "On the fourth side, verandas which are supported by ornate pillars overlook the steps.", acceptedAnswers: ["verandahs", "verandas"] },
  ...
  },
  {
    ...
    questions: [
      ...
      { number: 2, answer: "10 times", passageKeyword: "average forest", questionKeyword: "size fires greater two decades", thaiMeaning: "จากข้อความใน", exactPortion: "10 times the size of the average forest fire of 20 years ago.", acceptedAnswers: ["10 times", "ten times", "10", "ten"] },
  ...
  },
  {
    ...
    questions: [
      ...
      { number: 6, answer: "trays", passageKeyword: "variation vertical farming developed", questionKeyword: "vertical farming involves", thaiMeaning: "จากข้อความใน", exactPortion: "One variation on vertical farming that has been developed is to grow plants in stacked trays that move on rails.", acceptedAnswers: ["trays", "stacked trays"] },
      { number: 7, answer: "rooftops", passageKeyword: "possible skyscrapers future experts", questionKeyword: "probable development grown", thaiMeaning: "จากข้อความใน", exactPortion: "While it is possible that much of our food will be grown in skyscrapers in future, most experts currently believe it is far more likely that we will simply use the space available on urban rooftops.", acceptedAnswers: ["rooftops", "urban rooftops"] },
    ]
  },
  {
    examId: "journey-normal-stage-5",
