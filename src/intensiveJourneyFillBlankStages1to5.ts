...
export const INTENSIVE_JOURNEY_FILL_BLANK_STAGES_1_5: NewFillBlankSet[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { number: 2, answer: "10", passageKeyword: "average forest", questionKeyword: "decades", thaiMeaning: "จากข้อความใน", exactPortion: "10 times the size of the average forest fire of 20 years ago.", acceptedAnswers: ["10", "ten", "10 times", "ten times"] },
