...
export type WgbSelectBlank = {
  ...
  options: string[]
  answer: string
  focus: 'paraphrase' | 'word-choice' | 'transition' | 'referencing'
}
...
export const STEP_COACH_TH: Record<WgbStep['role'], string> = {
  intro:
    'ย่อหน้านี้คือ Introduction ครับ หัวใจสำคัญคือการ "พาราเฟรส" โจทย์ — ห้ามลอกประโยคเดิมมาทั้งดุ้น พาราเฟรสทำได้ 2 วิธี ① เปลี่ยนคำเป็นคำพ้องความหมาย (synonym) ② เปลี่ยนโครงสร้างประโยคใหม่ ลองดูช่องว่างข้างล่างนี้สิ แต่ละช่องเราจะใช้ synonym คำไหนแทนคำในโจทย์ดี? นอกจากนี้ยังมีเทคนิคเสริมที่ควรฝึกใช้: เครื่องหมาย colon ( : ) ตอนจะขยายความ และคำว่า "such as" ตอนจะยกตัวอย่าง',
  overview:
    'ย่อหน้า Overview คือการสรุปภาพรวมก่อนลงรายละเอียด ก่อนตอบ ลองมองกราฟทางซ้ายดีๆ ก่อนนะครับ — ภาพรวมของข้อมูลเป็นแนวโน้ม "ขาขึ้น" (upward) หรือ "ขาลง" (downward)? มีเส้นไหนสวนทางเส้นอื่นบ้างไหม? เดาก่อนว่าคำที่ต้องเติมควรสื่อทิศทางแบบไหน แล้วค่อยเลือกคำตอบ',
  body1:
    'ย่อหน้า Body 1 เล่ารายละเอียดช่วงแรกของกราฟ ทุกครั้งที่ขึ้นประโยคใหม่ ให้เดาก่อนว่าต้องใช้ "คำเชื่อม" (transition word) อะไร เช่น However, Whereas, For example ฯลฯ ส่วนช่องกริยา ให้คิดตามลำดับ: (1) tense ควรเป็นปัจจุบันหรืออดีต (2) ต้องมี adverb บอกระดับไหม เช่น dramatically, steadily (3) ต้องผันเป็นรูปไหน (V-ing หรือ V3)?',
  body2:
    'ย่อหน้า Body 2 เล่าช่วงหลังของกราฟจนถึงจุดสิ้นสุด เหมือน Body 1 เลย — ก่อนเติมทุกประโยคใหม่ ให้เดาคำเชื่อม (transition word) ก่อน แล้วช่องกริยาก็คิดเรื่อง tense, ต้องมี adverb บอกระดับไหม, และรูปกริยา (V-ing / V3) เหมือนเดิม'
}
...
export const BLANK_COACH_TH: Record<WgbBlank['focus'], string> = {
  paraphrase:
    'ช่องนี้คือการพาราเฟรส — เดาดูสิว่าควรใช้ "คำพ้องความหมาย" (synonym) แทนคำในโจทย์ หรือเป็นการเปลี่ยนโครงสร้างประโยค?',
  'word-choice': 'เลือกคำที่ความหมายและไวยากรณ์เข้ากับประโยคที่สุด ลองอ่านทั้งประโยคก่อนตัดสินใจนะครับ',
  transition:
    'ประโยคใหม่กำลังจะเริ่ม — คิดก่อนว่าควรใช้คำเชื่อมตัวไหน (However / Whereas / For example / On the other hand ฯลฯ) ให้เข้ากับความหมาย',
  referencing: 'ตรงนี้กำลังอ้างถึงคำนามที่พูดถึงไปแล้ว ควรใช้ "this number" หรือ "that of" แบบไหนถึงจะถูก?',
  'verb-tense': 'คิดก่อนตอบ: กริยาตัวนี้ควรเป็น present tense หรือ past tense? แล้วดูด้วยว่าประธานเอกพจน์หรือพหูพจน์',
    ...
    steps: [
      {
        ...
        segments: [
          ...
          t(' of students who used online learning platforms over a ten-year period, '),
      ...
      },
      {
        ...
        segments: [
          t('Overall, the figure '),
          typ('gb1-o1', 'rise', ['rose'], 'verb-tense'),
          t(' '),
          sel('gb1-o2', ['considerably', 'slightly', 'barely'], 'considerably', 'word-choice'),
          t(' over the period, '),
          typ('gb1-o3', 'reach', ['reaching'], 'ving-clause'),
          t(' a peak in 2024. '),
          sel('gb1-o4', ['However', 'Moreover', 'Therefore'], 'However', 'transition'),
          t(', the growth was much faster in the second half of the period than in the first.')
        ]
      },
      {
        id: 'gb1-body1',
        ...
        hintTh: HINT_CONJUGATE,
        segments: [
          t('Starting in 2014 at just 18%, the figure '),
          typ('gb1-b1', 'increase', ['increased'], 'verb-tense'),
          t(' '),
          sel('gb1-b2', ['steadily', 'sharply', 'suddenly'], 'steadily', 'word-choice'),
          t(', '),
          typ('gb1-b3', 'climb', ['climbing'], 'ving-clause'),
          t(' to 34% by 2018. '),
          sel('gb1-b4', ['However', 'As a result', 'Similarly'], 'However', 'transition'),
          t(', the pace of growth during this early period '),
          typ('gb1-b5', 'remain', ['remained'], 'verb-tense'),
          t(' fairly '),
          sel('gb1-b6', ['slow', 'quick', 'high'], 'slow', 'word-choice'),
          t('.')
        ]
      },
      {
        ...
        segments: [
          ...
          typ('gb1-c1', 'rise', ['rose'], 'verb-tense'),
          t(' far more '),
          sel('gb1-c2', ['sharply', 'gently', 'slowly'], 'sharply', 'word-choice'),
          t(', '),
          typ('gb1-c3', 'reach', ['reaching'], 'ving-clause'),
          t(' 58% in 2020. It then '),
          typ('gb1-c4', 'continue', ['continued'], 'verb-tense'),
          t(' to climb, '),
          typ('gb1-c5', 'peak', ['peaking'], 'ving-clause'),
          t(' at 74% in 2024. '),
          sel('gb1-c6', ['This figure', 'These figure', 'This figures'], 'This figure', 'referencing'),
          t(' was more than four times '),
          sel('gb1-c7', ['that', 'those', 'it'], 'that', 'referencing'),
          t(' recorded at the start of the period.')
        ]
      }
    ]
  },
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        segments: [
          t('Overall, spending '),
          typ('gb2-o1', 'grow', ['grew'], 'verb-tense'),
          t(' '),
          sel('gb2-o2', ['dramatically', 'marginally', 'rarely'], 'dramatically', 'word-choice'),
          t(' over the period, '),
          typ('gb2-o3', 'increase', ['increasing'], 'ving-clause'),
          t(' almost fivefold. '),
          sel('gb2-o4', ['However', 'In addition', 'Because'], 'However', 'transition'),
          t(', most of this growth happened after 2018.')
        ]
      },
      {
        id: 'gb2-body1',
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        segments: [
          t('Overall, the figure '),
          typ('gb3-o1', 'peak', ['peaked'], 'verb-tense'),
          t(' sharply in 2020 before '),
          typ('gb3-o2', 'fall', ['falling'], 'ving-clause'),
          t(' slightly, '),
          sel('gb3-o3', ['yet', 'so', 'or'], 'yet', 'word-choice'),
          t(' it '),
          typ('gb3-o4', 'remain', ['remained'], 'verb-tense'),
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        segments: [
          t('Overall, sales '),
          typ('gb4-o1', 'increase', ['increased'], 'verb-tense'),
          t(' '),
          sel('gb4-o2', ['continuously', 'briefly', 'rarely'], 'continuously', 'word-choice'),
          t(' throughout the period, '),
          typ('gb4-o3', 'reach', ['reaching'], 'ving-clause'),
          t(' their '),
          sel('gb4-o4', ['highest', 'lowest', 'average'], 'highest', 'word-choice'),
    ...
    steps: [
      ...
      },
      {
        ...
        segments: [
          ...
          typ('gb5-o1', 'rise', ['rose'], 'verb-tense'),
          t(' '),
          sel('gb5-o2', ['rapidly', 'hardly', 'briefly'], 'rapidly', 'word-choice'),
          t(', '),
          typ('gb5-o3', 'become', ['becoming'], 'ving-clause'),
          t(' '),
          sel('gb5-o4', ['common', 'rare', 'unusual'], 'common', 'word-choice'),
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        segments: [
          t('Overall, the figure '),
          typ('gb6-o1', 'rise', ['rose'], 'verb-tense'),
    ...
    steps: [
      ...
      },
      {
        ...
        segments: [
          ...
          typ('gb7-o1', 'grow', ['grew'], 'verb-tense'),
          t(' in every region, '),
