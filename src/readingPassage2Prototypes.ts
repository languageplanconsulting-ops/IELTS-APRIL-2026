...
export const READING_PASSAGE_2_PROTOTYPE_PATTERN_NOTES = `Passage 2 prototype pattern:
- Length is usually about 850-1,100 words, with six or seven labelled paragraphs (A-F or A-G).
...
Around 25 million elms, accounting for 90% of all elm trees in the UK, died during the 1960s and 70s of Dutch elm disease. In the aftermath, the elm, once so dominant in the British landscape, was largely forgotten. However, there is now hope the elm may be reintroduced to the countryside of central and southern England. Any reintroduction will start from a very low base. 'The impact of the disease is difficult to picture if you had not seen what was there before,' says Matt Elliot of the Woodland Trust. 'You look at old photographs from the 1960s and it is only then that you realise the impact elms had. They were significant, large trees, then they were gone.'
...
Given how ingrained elm is in British culture, it is unsurprising the tree has many advocates. Amongst them is Peter Bourne of the National Elm Collection in Brighton. 'I saw Dutch elm disease unfold as a small boy,' he says. 'The elm seemed to be part of rural England, but I remember watching trees just lose their leaves and that really stayed with me.' Today, the city of Brighton's elms total about 17,000. Local factors appear to have contributed to their survival. Strong winds from the sea make it difficult for the determined elm bark beetle to attack this coastal city's elm population. However, the situation is precarious. 'The beetles can just march in if we are not careful, as the threat is right on our doorstep,' says Bourne.
...
All of this raises questions of social acceptance, acknowledges Russell. 'If we are putting elm back into the landscape, a small element of it is not native - are we bothered about that?' For her, the environmental case for reintroducing elm is strong. 'They will host wildlife, which is a good thing.' Others are more wary. 'On the face of it, it seems like a good idea,' says Elliot. The problem, he suggests, is that, 'You are replacing a native species with a horticultural analogue. You are effectively cloning.' There is also the risk of introducing new diseases. Rather than plant new elms, the Woodland Trust emphasises providing space to those elms that have survived independently. 'Sometimes the best thing you can do is just give nature time to recover. Over time, you might get resistance,' says Elliot.
...
18 reference to the stage at which young elms become vulnerable to Dutch elm disease`
  ...
  {
    id: 'ancient-mediterranean-pirates',
...
Procrastination is only a short-term measure for managing emotions. It is often followed by a feeling of 22 ............... , which worsens our mood and leads to more procrastination.
...
C They do not keep their jobs for as long.
D They do not enjoy their working lives as much.
