...
export type Wgb2Focus = 'verb-tense' | 'plural' | 'transition' | 'article' | 'comma' | 'participle' | 'punct'
...
export const WGB2_BLANK_COACH_TH: Record<Wgb2Focus, string> = {
  ...
  participle:
    'V3 (past participle) ทำหน้าที่เป็นคำคุณศัพท์วางหน้าคำนามได้ เมื่อคำนามนั้น "ถูกกระทำ" เช่น "preserved houses" = บ้านที่ถูกอนุรักษ์ไว้ ต่างจาก V1 ที่แปลว่า "ทำเอง"',
  punct:
    'เลือกเครื่องหมายวรรคตอนที่ถูกต้อง — comma ใช้กับวลีสั้น ๆ, full stop ใช้ตัดจบประโยค, semicolon (;) ใช้เชื่อม 2 ประโยคสมบูรณ์ก่อนคำเชื่อมอย่าง however/therefore'
}
    ...
    steps: [
      {
        ...
        segments: [
          ...
          typ2('t2-twe-1-i0', 'argue', ['argued'], 'verb-tense', 'passive voice "has been + V3" จึงใช้ argued (V3)'),
          t2(' that while some old '),
          ...
          t2(' may appear outdated'),
          punc2('t2-twe-1-i2', ['comma', 'period', 'none'], 'comma', 'comma หลัง while-clause ("while...outdated") ก่อนขึ้นประธานใหม่ ("maintaining them...") ในประโยคเดียวกัน'),
          t2(' '),
          typ2('t2-twe-1-i2b', 'maintain', ['maintaining'], 'verb-tense', '"maintaining them" เป็น gerund phrase ทำหน้าที่เป็นประธานประโยค จึงใช้ v-ing'),
          t2(' them '),
          ...
          t2(" country's history and cultural identity. Others "),
          typ2('t2-twe-1-i4b', 'argue', ['argue'], 'verb-tense', 'ประธาน "Others" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s (ไม่ใช่ argues)'),
          t2(' that pulling down these structures and '),
          typ2('t2-twe-1-i4c', 'replace', ['replacing'], 'verb-tense', 'ขนานกับ "pulling down" ด้านหน้า (parallel -ing form) จึงใช้ replacing'),
          t2(
            ' them with modern buildings would better meet the practical '
          ),
          ...
          t2(' '),
          typ2('t2-twe-1-i6b', 'grow', ['growing'], 'participle', '"growing population" — v-ing ทำหน้าที่คุณศัพท์วางหน้าคำนาม แปลว่าประชากรที่กำลังเพิ่มขึ้น'),
          t2(' population. I personally believe that historic buildings should be '),
          typ2('t2-twe-1-i7', 'preserve', ['preserved'], 'verb-tense', 'โครงสร้าง passive voice "should be + V3" จึงต้องใช้ preserved'),
          t2(', and my reasons will be '),
          typ2('t2-twe-1-i8', 'elaborate', ['elaborated'], 'verb-tense', 'passive voice "will be + V3" จึงใช้ elaborated'),
      ...
      },
      {
        ...
        segments: [
          drag2('t2-twe-1-b1start', ['To begin with', 'In this respect', 'For instance'], 'To begin with', '"To begin with" ใช้เปิดย่อหน้าแรกเพื่อเริ่มเหตุผลข้อแรก'),
          t2(', it might seem sensible for some to claim that old '),
          ...
          t2(' to make way for modern infrastructure. '),
          drag2('t2-twe-1-b1mid', ['To explain it simply', 'However', 'In conclusion'], 'To explain it simply', '"To explain it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is possibly because older structures often fail to meet current safety and space '),
          typ2('t2-twe-1-b1c', 'requirement', ['requirements'], 'plural', '"safety and space requirements" หมายถึงข้อกำหนดหลายข้อ จึงเป็นพหูพจน์'),
          punc2('t2-twe-1-b1d', ['semicolon', 'period', 'comma'], 'semicolon', 'เชื่อม 2 ประโยคสมบูรณ์เข้าด้วยกันก่อนคำเชื่อม therefore จึงใช้ semicolon (;)'),
          t2(' therefore'),
          punc2('t2-twe-1-b1d2', ['comma', 'period', 'none'], 'comma', 'หลังคำเชื่อม therefore ต้องมี comma เสมอก่อนขึ้นประโยคหลัก'),
          t2(' replacing them '),
          typ2('t2-twe-1-b1e0', 'allow', ['allows'], 'verb-tense', 'ประธาน "replacing them" (gerund) เป็นเอกพจน์ กริยาจึงเติม -s เป็น allows'),
          t2(' cities to meet the needs of a growing population more efficiently. '),
          drag2('t2-twe-1-b1f', ['For example', 'However', 'To begin with'], 'For example', '"For example" ยกตัวอย่างเมืองจริงมาสนับสนุนประโยคก่อนหน้า'),
          t2(', many rapidly '),
          typ2('t2-twe-1-b1e', 'develop', ['developing'], 'participle', '"rapidly developing cities" — v-ing ทำหน้าที่คุณศัพท์ขยาย cities'),
          t2(' cities have '),
          typ2('t2-twe-1-b1e2', 'pull down', ['pulled down'], 'verb-tense', 'present perfect "have + V3" จึงใช้ pulled down'),
          t2(' old buildings to construct '),
          sel2(
            't2-twe-1-b1g',
      ...
      },
      {
        ...
        segments: [
          drag2('t2-twe-1-b2start', ['However', 'For instance', 'To begin with'], 'However', 'ย่อหน้านี้ขัดแย้งกับย่อหน้าก่อนหน้า (concession → rebuttal) จึงใช้ However'),
          ...
          t2('. '),
          drag2('t2-twe-1-b2mid', ['To put it simply', 'For example', 'In conclusion'], 'To put it simply', '"To put it simply" ใช้ก่อนอธิบายเหตุผลให้เข้าใจง่าย'),
          t2(', this is due to the fact that these '),
          ...
          t2('. '),
          drag2('t2-twe-1-b2f', ['For instance', 'However', 'To begin with'], 'For instance', '"For instance" ยกตัวอย่างเมือง Rome และ Kyoto มาสนับสนุน'),
          t2(', cities such as Rome and Kyoto attract millions of '),
          typ2('t2-twe-1-b2f2', 'tourist', ['tourists'], 'plural', '"millions of tourists" ตามด้วยคำนามพหูพจน์เสมอ'),
          t2(' every year largely because of their well-'),
          typ2('t2-twe-1-b2g0', 'preserve', ['preserved'], 'participle', '"well-preserved historic buildings" — V3 ทำหน้าที่คุณศัพท์วางหน้าคำนาม แปลว่าอาคารที่ถูกอนุรักษ์ไว้อย่างดี'),
          t2(' historic buildings. '),
          drag2('t2-twe-1-b2g', ['In this respect', 'However', 'For example'], 'In this respect', '"In this respect" สรุปมุมมองในย่อหน้านี้ก่อนขึ้นประโยคปิดท้าย'),
          t2(', it is evident that '),
          typ2('t2-twe-1-b2g2', 'maintain', ['maintaining'], 'verb-tense', '"maintaining old buildings" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' old buildings brings both cultural and economic value to '),
          sel2('t2-twe-1-b2h', ['a', 'the', WGB2_NO_ARTICLE], 'a', 'article', '"a country" พูดถึงประเทศทั่วไป ไม่เจาะจงประเทศใดประเทศหนึ่ง จึงใช้ a'),
          t2(' country.')
        ]
      },
      {
        ...
        segments: [
          drag2('t2-twe-1-cstart', ['In conclusion', 'However', 'For example'], 'In conclusion', '"In conclusion" เปิดย่อหน้าสรุปเสมอ'),
          t2(', although it is undeniable that building modern structures can help cities meet '),
          typ2('t2-twe-1-c0', 'grow', ['growing'], 'participle', '"growing practical needs" — v-ing ทำหน้าที่คุณศัพท์ แปลว่าความต้องการที่กำลังเพิ่มขึ้น'),
          t2(' practical '),
          typ2('t2-twe-1-c1', 'need', ['needs'], 'plural', '"practical needs" ของประชากรที่กำลังเติบโต เป็นพหูพจน์เสมอ'),
          t2(', I am of the opinion that '),
          typ2('t2-twe-1-c1b', 'preserve', ['preserving'], 'verb-tense', '"preserving old buildings" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' old buildings '),
          comma2(
            't2-twe-1-c2',
    ...
    steps: [
      {
        ...
        segments: [
          t2('It has been widely '),
          typ2('t2-twe-2-i0', 'argue', ['argued'], 'verb-tense', 'passive voice "has been + V3" จึงใช้ argued'),
          t2(' that while the past cannot be changed, '),
          typ2('t2-twe-2-i1', 'understand', ['understanding'], 'verb-tense', '"understanding it" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' it has little practical relevance to people '),
          typ2('t2-twe-2-i2', 'live', ['living'], 'participle', '"people living in the present" — v-ing ทำหน้าที่คุณศัพท์ขยาย people'),
          t2(' in the present. Others '),
          typ2('t2-twe-2-i3', 'argue', ['argue'], 'verb-tense', 'ประธาน "Others" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' that '),
          typ2('t2-twe-2-i4', 'study', ['studying'], 'verb-tense', '"studying history" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' history remains essential for '),
          typ2('t2-twe-2-i5', 'understand', ['understanding'], 'verb-tense', 'ขนานกับ improving ด้านหลัง (parallel gerund)'),
          t2(' and '),
          typ2('t2-twe-2-i6', 'improve', ['improving'], 'verb-tense', 'ขนานกับ understanding ด้านหน้า (parallel gerund)'),
          t2(' present-day society. I personally believe that '),
          typ2('t2-twe-2-i7', 'learn', ['learning'], 'verb-tense', '"learning about the past" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' about the past is highly valuable, and my reasons will be '),
          typ2('t2-twe-2-i8', 'elaborate', ['elaborated'], 'verb-tense', 'passive voice "will be + V3" จึงใช้ elaborated'),
          t2(' on in the following paragraphs.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.body1,
        segments: [
          drag2('t2-twe-2-b1start', ['To begin with', 'To explain it simply', 'For example'], 'To begin with', '"To begin with" ใช้เปิดย่อหน้าแรกเพื่อเริ่มเหตุผลข้อแรก'),
          ...
          t2(' history '),
          typ2('t2-twe-2-b1b', 'serve', ['serves'], 'verb-tense', 'ประธาน "studying history" (gerund phrase) นับเป็นเอกพจน์ จึงใช้ serves'),
          t2(' little practical purpose in modern life. '),
          drag2('t2-twe-2-b1mid', ['To explain it simply', 'To begin with', 'From this perspective'], 'To explain it simply', '"To explain it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is possibly because historical events cannot be '),
          typ2('t2-twe-2-b1c', 'alter', ['altered'], 'verb-tense', 'passive voice "cannot be + V3" จึงใช้ altered'),
          t2(' and have no direct bearing on today\'s technology or economy'),
          punc2('t2-twe-2-b1d', ['semicolon', 'period', 'comma'], 'semicolon', 'semicolon ก่อน therefore ที่เชื่อมสองประโยคสมบูรณ์ที่เกี่ยวข้องกัน'),
          t2(' therefore'),
          punc2('t2-twe-2-b1d2', ['comma', 'period', 'none'], 'comma', 'comma หลัง therefore ก่อนขึ้นใจความหลักของประโยค'),
          t2(' some believe time would be better '),
          typ2('t2-twe-2-b1e', 'spend', ['spent'], 'verb-tense', 'passive voice "would be better + V3" จึงใช้ spent'),
          t2(' '),
          typ2('t2-twe-2-b1f', 'learn', ['learning'], 'verb-tense', '"learning practical skills" เป็น gerund phrase ทำหน้าที่กรรมของ spent'),
          t2(' practical skills instead. '),
          drag2('t2-twe-2-b1g', ['For example', 'To begin with', 'In this respect'], 'For example', '"For example" ยกตัวอย่างนักเรียนที่เลือกเรียนวิชาอื่น'),
          t2(', many students today '),
          typ2('t2-twe-2-b1h', 'choose', ['choose'], 'verb-tense', 'ประธาน "many students" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' to '),
          typ2('t2-twe-2-b1i', 'study', ['study'], 'verb-tense', 'ขนานกับ to choose ด้านหน้า (parallel infinitive to + base verb)'),
          t2(' coding or business rather than history, '),
          typ2('t2-twe-2-b1j', 'believe', ['believing'], 'verb-tense', '"believing these subjects offer..." เป็น participle phrase ขยายประโยคหลัก'),
          t2(' these subjects '),
          typ2('t2-twe-2-b1k', 'offer', ['offer'], 'verb-tense', 'ประธาน "these subjects" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' more immediate career benefits. '),
          drag2('t2-twe-2-b1l', ['From this perspective', 'To explain it simply', 'For instance'], 'From this perspective', '"From this perspective" สรุปมุมมองของฝ่ายที่เห็นต่างก่อนขึ้นย่อหน้าถัดไป'),
          t2(', it is understandable why some would believe that '),
          typ2('t2-twe-2-b1m', 'focus', ['focusing'], 'verb-tense', '"focusing on the present" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' on the present is more useful than '),
          typ2('t2-twe-2-b1n', 'study', ['studying'], 'verb-tense', '"studying the past" เป็น gerund phrase หลัง than'),
          t2(' the past.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.body2,
        segments: [
          drag2('t2-twe-2-b2start', ['However', 'To begin with', 'For example'], 'However', '"However" เปิดย่อหน้าเพื่อโต้แย้งมุมมองในย่อหน้าก่อนหน้า'),
          ...
          t2(' about the past is essential. '),
          drag2('t2-twe-2-b2mid', ['To put it simply', 'However', 'In this respect'], 'To put it simply', '"To put it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is due to the fact that history '),
          typ2('t2-twe-2-b2b', 'allow', ['allows'], 'verb-tense', 'ประธาน "history" เป็นเอกพจน์ จึงใช้ allows'),
          t2(' societies to '),
          typ2('t2-twe-2-b2c', 'understand', ['understand'], 'verb-tense', 'ขนานกับ to + base verb หลัง allows...to'),
          t2(' the causes of present problems and avoid '),
          typ2('t2-twe-2-b2d', 'repeat', ['repeating'], 'verb-tense', '"avoid repeating" ตามด้วย gerund เสมอหลัง avoid'),
          t2(' past mistakes, which can be extremely costly. '),
          drag2('t2-twe-2-b2e', ['For instance', 'To put it simply', 'In this respect'], 'For instance', '"For instance" ยกตัวอย่างวิกฤตการเงินปี 2008'),
          t2(', many countries continue to '),
          typ2('t2-twe-2-b2f', 'study', ['study'], 'verb-tense', 'ขนานกับ to + base verb หลัง continue to'),
          t2(' the causes of the 2008 financial crisis in order to '),
          typ2('t2-twe-2-b2g', 'prevent', ['prevent'], 'verb-tense', '"in order to + base verb" ใช้รูปกริยาเดิมเสมอ'),
          t2(' similar economic collapses in the future. '),
          drag2('t2-twe-2-b2h', ['In this respect', 'For instance', 'However'], 'In this respect', '"In this respect" สรุปมุมมองในย่อหน้านี้ก่อนขึ้นประโยคปิดท้าย'),
          t2(', it is evident that '),
          typ2('t2-twe-2-b2i', 'study', ['studying'], 'verb-tense', '"studying history" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' history '),
          typ2('t2-twe-2-b2j', 'provide', ['provides'], 'verb-tense', 'ประธาน "studying history" (gerund phrase) นับเป็นเอกพจน์ จึงใช้ provides'),
          t2(' valuable lessons that directly '),
          typ2('t2-twe-2-b2k', 'benefit', ['benefit'], 'verb-tense', 'ประธาน "lessons" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' the present.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.conclusion,
        segments: [
          drag2('t2-twe-2-cstart', ['In conclusion', 'However', 'For example'], 'In conclusion', '"In conclusion" เปิดย่อหน้าสรุปเสมอ'),
          t2(', although it is undeniable that historical events themselves cannot be '),
          typ2('t2-twe-2-c0', 'change', ['changed'], 'verb-tense', 'passive voice "cannot be + V3" จึงใช้ changed'),
          t2(', I am of the opinion that '),
          typ2('t2-twe-2-c1', 'learn', ['learning'], 'verb-tense', '"learning about the past" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' about the past is highly valuable, as it '),
          typ2('t2-twe-2-c2', 'help', ['helps'], 'verb-tense', 'ประธาน "it" เป็นเอกพจน์ จึงใช้ helps'),
          t2(' societies avoid '),
          typ2('t2-twe-2-c3', 'repeat', ['repeating'], 'verb-tense', '"avoid repeating" ตามด้วย gerund เสมอหลัง avoid'),
          t2(' the same mistakes.')
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        segments: [
          t2('It has been widely '),
          typ2('t2-twe-7-i0', 'argue', ['argued'], 'verb-tense', 'passive voice "has been + V3" จึงใช้ argued'),
          t2(' that while '),
          typ2('t2-twe-7-i1', 'treat', ['treating'], 'verb-tense', '"treating illness" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' illness remains necessary, governments should prioritize public spending on '),
          typ2('t2-twe-7-i2', 'promote', ['promoting'], 'verb-tense', '"promoting healthy lifestyles" เป็น gerund phrase หลัง on'),
          t2(' healthy lifestyles over '),
          typ2('t2-twe-7-i3', 'treat', ['treating'], 'verb-tense', 'ขนานกับ promoting ด้านหน้า (parallel gerund หลัง over)'),
          t2(' people who are already sick. Others argue that treatment should remain the top funding priority, since sick people need immediate medical care. I personally believe that prevention deserves greater public investment, and my reasons will be '),
          typ2('t2-twe-7-i4', 'elaborate', ['elaborated'], 'verb-tense', 'passive voice "will be + V3" จึงใช้ elaborated'),
          t2(' on in the following paragraphs.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.body1,
        segments: [
          drag2('t2-twe-7-b1start', ['To begin with', 'To explain it simply', 'For example'], 'To begin with', '"To begin with" ใช้เปิดย่อหน้าแรกเพื่อเริ่มเหตุผลข้อแรก'),
          t2(', it might seem sensible for some to claim that '),
          typ2('t2-twe-7-b1a', 'treat', ['treating'], 'verb-tense', '"treating existing illness" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' existing illness should remain the government\'s main priority. '),
          drag2('t2-twe-7-b1mid', ['To explain it simply', 'To begin with', 'From this perspective'], 'To explain it simply', '"To explain it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is possibly because sick patients require urgent medical attention that cannot be '),
          typ2('t2-twe-7-b1b', 'delay', ['delayed'], 'verb-tense', 'passive voice "cannot be + V3" จึงใช้ delayed'),
          punc2('t2-twe-7-b1c', ['semicolon', 'period', 'comma'], 'semicolon', 'semicolon ก่อน therefore ที่เชื่อมสองประโยคสมบูรณ์ที่เกี่ยวข้องกัน'),
          t2(' therefore'),
          punc2('t2-twe-7-b1c2', ['comma', 'period', 'none'], 'comma', 'comma หลัง therefore ก่อนขึ้นใจความหลักของประโยค'),
          t2(' reducing treatment funding could put vulnerable lives at serious risk. '),
          drag2('t2-twe-7-b1d', ['For example', 'To begin with', 'In this respect'], 'For example', '"For example" ยกตัวอย่างผู้ป่วยมะเร็งและผู้ประสบอุบัติเหตุ'),
          t2(', cancer patients and accident victims often '),
          typ2('t2-twe-7-b1e', 'need', ['need'], 'verb-tense', 'ประธาน "cancer patients and accident victims" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' immediate hospital care regardless of how much money is '),
          typ2('t2-twe-7-b1f', 'spend', ['spent'], 'verb-tense', 'passive voice "is + V3" จึงใช้ spent'),
          t2(' on prevention. '),
          drag2('t2-twe-7-b1g', ['From this perspective', 'To explain it simply', 'For instance'], 'From this perspective', '"From this perspective" สรุปมุมมองของฝ่ายที่เห็นต่างก่อนขึ้นย่อหน้าถัดไป'),
          t2(', it is understandable why some would believe that '),
          typ2('t2-twe-7-b1h', 'treat', ['treating'], 'verb-tense', '"treating the sick" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' the sick should take precedence over prevention campaigns.')
        ]
      },
      {
        id: 'gb2-pvt-body2',
        ...
        labelTh: WGB2_ROLE_LABEL_TH.body2,
        segments: [
          drag2('t2-twe-7-b2start', ['However', 'To begin with', 'For example'], 'However', '"However" เปิดย่อหน้าเพื่อโต้แย้งมุมมองในย่อหน้าก่อนหน้า'),
          t2(', I would personally argue in favor of the idea that '),
          typ2('t2-twe-7-b2a', 'promote', ['promoting'], 'verb-tense', '"promoting healthy lifestyles" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' healthy lifestyles deserves greater public investment. '),
          drag2('t2-twe-7-b2mid', ['To put it simply', 'However', 'In this respect'], 'To put it simply', '"To put it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is due to the fact that '),
          typ2('t2-twe-7-b2b', 'prevent', ['preventing'], 'verb-tense', '"preventing illness" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' illness before it '),
          typ2('t2-twe-7-b2c', 'develop', ['develops'], 'verb-tense', 'ประธาน "it" เป็นเอกพจน์ จึงใช้ develops'),
          t2(' reduces long-term healthcare costs, which ultimately '),
          typ2('t2-twe-7-b2d', 'benefit', ['benefits'], 'verb-tense', 'ประธาน "which" อ้างถึง reducing costs ที่เป็นเอกพจน์ จึงใช้ benefits'),
          t2(' the entire population. '),
          drag2('t2-twe-7-b2e', ['For instance', 'To put it simply', 'In this respect'], 'For instance', '"For instance" ยกตัวอย่างงานวิจัยขององค์การอนามัยโลกปี 2020'),
          t2(', a 2020 World Health Organization study '),
          typ2('t2-twe-7-b2f', 'find', ['found'], 'verb-tense', 'เหตุการณ์ในอดีตที่จบแล้ว (past simple) จึงใช้ found'),
          t2(' that every dollar '),
          typ2('t2-twe-7-b2g', 'spend', ['spent'], 'verb-tense', 'passive voice "dollar spent" (V3 ทำหน้าที่คุณศัพท์ขยาย dollar)'),
          t2(' on obesity-prevention programs '),
          typ2('t2-twe-7-b2h', 'save', ['saved'], 'verb-tense', 'เหตุการณ์ในอดีตที่จบแล้ว (past simple) จึงใช้ saved'),
          t2(' several dollars in future treatment costs. '),
          drag2('t2-twe-7-b2i', ['In this respect', 'For instance', 'However'], 'In this respect', '"In this respect" สรุปมุมมองในย่อหน้านี้ก่อนขึ้นประโยคปิดท้าย'),
          t2(', it is evident that prevention spending '),
          typ2('t2-twe-7-b2j', 'produce', ['produces'], 'verb-tense', 'ประธาน "prevention spending" เป็นเอกพจน์ จึงใช้ produces'),
          t2(' greater long-term benefits for public health systems.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.conclusion,
        segments: [
          drag2('t2-twe-7-cstart', ['In conclusion', 'However', 'For example'], 'In conclusion', '"In conclusion" เปิดย่อหน้าสรุปเสมอ'),
          t2(', although it is undeniable that '),
          typ2('t2-twe-7-c0', 'treat', ['treating'], 'verb-tense', '"treating sick patients" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' sick patients remains an urgent necessity, I am of the opinion that '),
          typ2('t2-twe-7-c1', 'promote', ['promoting'], 'verb-tense', '"promoting healthy lifestyles" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' healthy lifestyles should receive greater public funding, as prevention '),
          typ2('t2-twe-7-c2', 'reduce', ['reduces'], 'verb-tense', 'ประธาน "prevention" เป็นเอกพจน์ จึงใช้ reduces'),
          t2(' future healthcare burdens significantly.')
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        segments: [
          t2('It has been widely '),
          typ2('t2-twe-8-i0', 'argue', ['argued'], 'verb-tense', 'passive voice "has been + V3" จึงใช้ argued'),
          t2(' that while young drivers '),
          typ2('t2-twe-8-i1', 'gain', ['gain'], 'verb-tense', 'ประธาน "young drivers" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' independence early, '),
          typ2('t2-twe-8-i2', 'raise', ['raising'], 'verb-tense', '"raising the minimum age" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' the minimum age for '),
          typ2('t2-twe-8-i3', 'drive', ['driving'], 'verb-tense', '"driving cars and motorcycles" เป็น gerund phrase หลัง for'),
          t2(' cars and motorcycles is the best way to improve road safety. Others argue that stricter testing and driver education would be more effective than simply '),
          typ2('t2-twe-8-i4', 'raise', ['raising'], 'verb-tense', '"raising the age limit" เป็น gerund phrase หลัง than'),
          t2(' the age limit. I personally believe that '),
          typ2('t2-twe-8-i5', 'raise', ['raising'], 'verb-tense', '"raising the minimum driving age" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' the minimum driving age is the most effective solution, and my reasons will be '),
          typ2('t2-twe-8-i6', 'elaborate', ['elaborated'], 'verb-tense', 'passive voice "will be + V3" จึงใช้ elaborated'),
          t2(' on in the following paragraphs.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.body1,
        segments: [
          drag2('t2-twe-8-b1start', ['To begin with', 'To explain it simply', 'For example'], 'To begin with', '"To begin with" ใช้เปิดย่อหน้าแรกเพื่อเริ่มเหตุผลข้อแรก'),
          t2(', it might seem sensible for some to claim that better training programs would improve road safety more effectively than age restrictions. '),
          drag2('t2-twe-8-b1mid', ['To explain it simply', 'To begin with', 'From this perspective'], 'To explain it simply', '"To explain it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is possibly because skill and experience '),
          typ2('t2-twe-8-b1a', 'matter', ['matter'], 'verb-tense', 'ประธาน "skill and experience" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' more than age when '),
          typ2('t2-twe-8-b1b', 'operate', ['operating'], 'verb-tense', '"when operating a vehicle" เป็น gerund phrase หลัง when'),
          t2(' a vehicle safely'),
          punc2('t2-twe-8-b1c', ['semicolon', 'period', 'comma'], 'semicolon', 'semicolon ก่อน therefore ที่เชื่อมสองประโยคสมบูรณ์ที่เกี่ยวข้องกัน'),
          t2(' therefore'),
          punc2('t2-twe-8-b1c2', ['comma', 'period', 'none'], 'comma', 'comma หลัง therefore ก่อนขึ้นใจความหลักของประโยค'),
          t2(' some believe intensive driving courses could reduce accidents without '),
          typ2('t2-twe-8-b1d', 'delay', ['delaying'], 'verb-tense', '"without delaying independence" ตามด้วย gerund หลัง without'),
          t2(' independence. '),
          drag2('t2-twe-8-b1e', ['For example', 'To begin with', 'In this respect'], 'For example', '"For example" ยกตัวอย่างประเทศที่กำหนดบทเรียนเพิ่มเติม'),
          t2(', several countries already '),
          typ2('t2-twe-8-b1f', 'require', ['require'], 'verb-tense', 'ประธาน "several countries" เป็นพหูพจน์ กริยาปัจจุบันจึงไม่เติม -s'),
          t2(' additional lessons for newly '),
          typ2('t2-twe-8-b1g', 'license', ['licensed'], 'participle', '"newly licensed drivers" — V3 ทำหน้าที่คุณศัพท์ขยาย drivers แปลว่าผู้ขับที่เพิ่งได้รับใบขับขี่'),
          t2(' drivers before '),
          typ2('t2-twe-8-b1h', 'allow', ['allowing'], 'verb-tense', '"before allowing them" เป็น gerund phrase หลัง before'),
          t2(' them to drive unsupervised. '),
          drag2('t2-twe-8-b1i', ['From this perspective', 'To explain it simply', 'For instance'], 'From this perspective', '"From this perspective" สรุปมุมมองของฝ่ายที่เห็นต่างก่อนขึ้นย่อหน้าถัดไป'),
          t2(', it is understandable why some would believe that improved training addresses the root cause of dangerous driving.')
        ]
      },
      {
        id: 'gb2-da-body2',
        ...
        labelTh: WGB2_ROLE_LABEL_TH.body2,
        segments: [
          drag2('t2-twe-8-b2start', ['However', 'To begin with', 'For example'], 'However', '"However" เปิดย่อหน้าเพื่อโต้แย้งมุมมองในย่อหน้าก่อนหน้า'),
          t2(', I would personally argue in favor of the idea that '),
          typ2('t2-twe-8-b2a', 'raise', ['raising'], 'verb-tense', '"raising the minimum driving age" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' the minimum driving age is the most effective measure. '),
          drag2('t2-twe-8-b2mid', ['To put it simply', 'However', 'In this respect'], 'To put it simply', '"To put it simply" ใช้ก่อนขยายความเหตุผลให้เข้าใจง่ายขึ้น'),
          t2(', this is due to the fact that younger drivers\' brains are still '),
          typ2('t2-twe-8-b2b', 'develop', ['developing'], 'verb-tense', 'present continuous "are still + V-ing" จึงใช้ developing'),
          t2(' the judgment needed for quick decision-making, which extra training cannot fully '),
          typ2('t2-twe-8-b2c', 'replace', ['replace'], 'verb-tense', 'ขนานกับ cannot + base verb'),
          t2('. '),
          drag2('t2-twe-8-b2d', ['For instance', 'To put it simply', 'In this respect'], 'For instance', '"For instance" ยกตัวอย่างงานวิจัยขององค์การอนามัยโลกปี 2021'),
          t2(', a 2021 study by the World Health Organization '),
          typ2('t2-twe-8-b2e', 'find', ['found'], 'verb-tense', 'เหตุการณ์ในอดีตที่จบแล้ว (past simple) จึงใช้ found'),
          t2(' that drivers aged sixteen to nineteen are nearly three times more likely to crash than drivers over twenty-five. '),
          drag2('t2-twe-8-b2f', ['In this respect', 'For instance', 'However'], 'In this respect', '"In this respect" สรุปมุมมองในย่อหน้านี้ก่อนขึ้นประโยคปิดท้าย'),
          t2(', it is evident that '),
          typ2('t2-twe-8-b2g', 'raise', ['raising'], 'verb-tense', '"raising the minimum age" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' the minimum age directly targets the drivers most at risk of '),
          typ2('t2-twe-8-b2h', 'cause', ['causing'], 'verb-tense', '"at risk of causing accidents" ตามด้วย gerund หลัง of'),
          t2(' accidents.')
        ]
      },
      {
        ...
        labelTh: WGB2_ROLE_LABEL_TH.conclusion,
        segments: [
          drag2('t2-twe-8-cstart', ['In conclusion', 'However', 'For example'], 'In conclusion', '"In conclusion" เปิดย่อหน้าสรุปเสมอ'),
          t2(', although it is undeniable that better training could reduce some accidents, I am of the opinion that '),
          typ2('t2-twe-8-c0', 'raise', ['raising'], 'verb-tense', '"raising the minimum driving age" เป็น gerund phrase ทำหน้าที่ประธานประโยค'),
          t2(' the minimum driving age remains the most effective way to improve road safety.')
        ]
      }
    ]
  },
