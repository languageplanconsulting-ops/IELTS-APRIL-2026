    ...
    steps: [
      {
        ...
        segments: [
          ...
          t2(' buildings would '),
          sel2('t2-twe-1x-i4f', ['better', 'more good', 'gooder'], 'better', 'participle', 'รูปเปรียบเทียบ (comparative) ของ well คือ better ไม่ใช่ more good หรือ gooder'),
          t2(' '),
  ...
  t2('It '),
      ...
      },
      {
        ...
        segments: [
          ...
          t2(' '),
          sel2('t2-twe-2-b1hx', ['instead', 'instead of', 'insteadly'], 'instead', 'transition', '"instead" ทำหน้าที่ adverb แทนที่ ใช้รูปเดิม ไม่ใช่ "instead of" (ต้องตามด้วย noun) หรือ insteadly (ไม่มีคำนี้)'),
          t2('. '),
      ...
      steps: [
        ...
        },
        {
          ...
          segments: [
            ...
            t2(' '),
            sel2('t2-twe-7-c6b', ['future', 'futures', 'futurely'], 'future', 'participle', '"future healthcare burdens" ใช้ future เป็นคำคุณศัพท์ขยาย healthcare burdens'),
            t2(' healthcare '),
