...
const importJsonPath = path.join(root, 'cambridge-reading-imports/cambridge-17-reading-import.json')
...
const fileBody = `export const USER_PROVIDED_READING_PRACTICE_CAMBRIDGE_17_EXAMS = ${JSON.stringify(exams, null, 2)}
`
...
console.log(`Wrote ${exams.length} Cambridge 17 reading exams (${qTotal} questions) to ${outputPath}`)
