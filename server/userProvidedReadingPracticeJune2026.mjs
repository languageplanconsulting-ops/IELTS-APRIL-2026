export const USER_PROVIDED_READING_PRACTICE_JUNE_2026_EXAMS = [
  {
    id: 'builtin-reading-june-2026-passage-1-running-shoes',
    title: 'IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed',
    category: 'normal',
...
In 2019, the fictional British long-distance runner Clara Benson won her first major international marathon after several seasons of promising but uneven performances. Her victory surprised many commentators. Four years earlier, Benson had been regarded as a talented athlete who could compete with elite runners but rarely threatened to beat them in the biggest races.

Several changes helped explain Benson’s improvement. One was obvious: in 2017, she began working with a former Olympic coach who changed her training schedule and racing strategy. Another change was far less noticeable. For years, Benson had used a traditional racing shoe with a thin sole and limited cushioning. In 2018, however, she began competing in a shoe with a thicker layer of lightweight foam and a curved plate embedded in the midsole. This alteration was small in appearance, but its effect on her running economy was significant.

The change Benson made is one example of the many options available to runners who wish to adjust their footwear. “Elite athletes rarely race in shoes taken directly from a shop shelf,” says Martin Vale, a specialist shoe technician based in Manchester. “Their shoes are usually adapted to their foot shape, running style and event distance. At the highest level, even a tiny difference can matter.” As a result, the shoes worn by leading runners are often not identical to the commercial versions available to ordinary customers.

The American middle-distance runners Daniel and Marcus Rahman, for example, have long been known for their exact footwear requirements. “We are extremely specific about our racing shoes,” they explain. “The shoes are first produced by our sponsor, but then they are sent to a workshop where the fit, sole stiffness and upper material are checked again.” They have experimented not only with different sole shapes, but also with different kinds of dye used on the shoe uppers. Their current racing shoes are slightly heavier than the average elite model and have a firmer plate beneath the forefoot.

The main reason for such modifications is simple: the difference between winning and losing in elite running can be measured in seconds, or even fractions of a second. Runners and their support teams are therefore increasingly willing to test unusual adjustments if these may provide a competitive advantage.

Footwear modification has a longer history than many people realise. In the 1960s, some track athletes began altering the arrangement of metal pins in their spikes to improve grip on different surfaces. In the 1980s, a small number of experimental shoes appeared with spring-like structures under the heel. One such model produced so much recoil that officials banned it from competition, arguing that it gave runners an artificial advantage. Since then, rule makers have paid close attention to developments in shoe technology.

Today, shoe adjustment is considered by many coaches to be as important as nutrition or training. Modifications can be divided into two main categories: changes to the upper part of the shoe and changes to the sole. The sole is usually the more important area, as it affects cushioning, stability and energy return. Athletes may change their shoes depending on the race distance, the running surface and the weather. High temperatures, for instance, can make certain foams softer, while wet conditions may require a different outsole pattern.

In the early days of modern running, most shoes were made from leather. This material was strong, but it absorbed water and became heavy in rain. Synthetic materials later became common because they were lighter, cheaper and easier to shape. Nylon mesh allowed better ventilation, while thermoplastic overlays helped support the foot without adding much weight. More recently, advanced foams have become central to racing-shoe design. These foams are designed to compress when the runner lands and then expand quickly as the foot leaves the ground.

Of all recent developments, carbon plates have attracted the most discussion. These plates are often placed inside the midsole and are designed to guide the foot forward during toe-off. Tests suggest that, when combined with suitable foam, a curved plate can reduce the amount of energy a runner uses at a given speed. In this sense, modern racing shoes have changed not only the equipment athletes wear but also the style of racing itself.

Some runners go beyond standard adjustments. The Spanish sprinter Mateo Ruiz once had three additional steel pins placed near the front of each shoe because he believed they improved his drive from the starting blocks. His coaches later claimed that this change contributed to his unusually powerful acceleration. Other athletes focus on comfort rather than speed. The Portuguese marathon runner Sofia Almeida replaced the original laces in her shoes with thinner elastic ones because the standard version created pressure across the top of her foot.

Running-shoe customisation has raised performance standards in ways that would have been difficult to imagine when athletes competed in heavy leather shoes with simple rubber soles. As materials continue to develop, further changes are almost certain, although sports authorities will continue to debate where useful innovation ends and unfair assistance begins.
...
1 People had expected Clara Benson to become a major marathon winner for several years before 2019.
2 The change Clara Benson made to her shoes was widely noticed by the public.
3 Most elite runners travel with a specialist shoe technician during competitions.
4 Daniel and Marcus Rahman use racing shoes that are lighter than most elite models.
5 The spring-like shoe banned in the 1980s was designed by a former Olympic runner.
6 Weather conditions can influence the type of shoe adjustment a runner makes.
7 Mateo Ruiz’s coaches believed that a change to his shoes helped his acceleration.
...
The running shoe and how it has changed

● Daniel and Marcus Rahman experimented with different types of 8………………… used on their shoe uppers.

● Some experimental shoes were banned because of the amount of 9………………… they produced.

● Shoe adjustment is now considered as important as nutrition or 10………………… .

● Early running shoes were usually made from 11………………… .

● Mateo Ruiz had extra steel 12………………… added to the front of his shoes.

● Sofia Almeida changed the 13………………… on her shoes because the original ones were uncomfortable.`,
    rawAnswerKey: `Question 1: People had expected Clara Benson to become a major marathon winner for several years before 2019.

Correct Answer: FALSE
Accepted Answers: FALSE
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Her victory surprised many commentators. Four years earlier, Benson had been regarded as a talented athlete who could compete with elite runners but rarely threatened to beat them in the biggest races."
Short Thai Explanation: ข้อนี้ผิด เพราะ passage บอกว่าชัยชนะของเธอทำให้หลายคนประหลาดใจ และก่อนหน้านั้นเธอแทบไม่ได้ถูกมองว่าจะชนะรายการใหญ่.
Paraphrased Vocabulary: expected to become a winner = had been expected to beat elite runners; contradicts "rarely threatened to beat them"

Question 2: The change Clara Benson made to her shoes was widely noticed by the public.

Correct Answer: FALSE
Accepted Answers: FALSE
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Another change was far less noticeable."
Short Thai Explanation: ข้อนี้ผิด เพราะการเปลี่ยนรองเท้าถูกบอกว่า “สังเกตเห็นได้น้อยมาก” ไม่ใช่คนทั่วไปสังเกตเห็นกว้างขวาง.
Paraphrased Vocabulary: widely noticed = noticeable; contradicts "far less noticeable"

Question 3: Most elite runners travel with a specialist shoe technician during competitions.

Correct Answer: NOT GIVEN
Accepted Answers: NOT GIVEN
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "says Martin Vale, a specialist shoe technician based in Manchester"
Short Thai Explanation: มีการพูดถึงช่างเทคนิครองเท้า แต่ไม่ได้บอกว่านักวิ่ง elite ส่วนใหญ่เดินทางไปแข่งพร้อมช่างเทคนิค.
Paraphrased Vocabulary: specialist shoe technician = shoe technician; travel during competitions = not stated

Question 4: Daniel and Marcus Rahman use racing shoes that are lighter than most elite models.

Correct Answer: FALSE
Accepted Answers: FALSE
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Their current racing shoes are slightly heavier than the average elite model"
Short Thai Explanation: ข้อนี้ผิด เพราะ passage บอกว่ารองเท้าของพวกเขาหนักกว่า model elite โดยเฉลี่ยเล็กน้อย ไม่ใช่เบากว่า.
Paraphrased Vocabulary: lighter than most elite models = opposite of "heavier than the average elite model"

Question 5: The spring-like shoe banned in the 1980s was designed by a former Olympic runner.

Correct Answer: NOT GIVEN
Accepted Answers: NOT GIVEN
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "In the 1980s, a small number of experimental shoes appeared with spring-like structures under the heel. One such model produced so much recoil that officials banned it from competition"
Short Thai Explanation: passage บอกว่ารองเท้าแบบ spring-like ถูกแบน แต่ไม่ได้บอกว่าใครเป็นคนออกแบบ หรือเกี่ยวกับอดีตนักกีฬาโอลิมปิก.
Paraphrased Vocabulary: banned in the 1980s = officials banned it; designed by a former Olympic runner = not stated

Question 6: Weather conditions can influence the type of shoe adjustment a runner makes.

Correct Answer: TRUE
Accepted Answers: TRUE
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Athletes may change their shoes depending on the race distance, the running surface and the weather."
Short Thai Explanation: ข้อนี้ถูก เพราะ passage บอกชัดว่า weather เป็นหนึ่งในปัจจัยที่ทำให้นักกีฬาเปลี่ยนรองเท้า.
Paraphrased Vocabulary: influence = may change depending on; weather conditions = the weather

Question 7: Mateo Ruiz’s coaches believed that a change to his shoes helped his acceleration.

Correct Answer: TRUE
Accepted Answers: TRUE
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "His coaches later claimed that this change contributed to his unusually powerful acceleration."
Short Thai Explanation: ข้อนี้ถูก เพราะ coaches บอกว่าการเปลี่ยนแปลงนี้มีส่วนช่วย acceleration ของเขา.
Paraphrased Vocabulary: helped his acceleration = contributed to his acceleration

Question 8: Daniel and Marcus Rahman experimented with different types of ______ used on their shoe uppers.

Correct Answer: dye
Accepted Answers: dye
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "They have experimented not only with different sole shapes, but also with different kinds of dye used on the shoe uppers."
Short Thai Explanation: คำตอบคือ dye เพราะโจทย์ถามสิ่งที่ใช้บน shoe uppers.
Paraphrased Vocabulary: different types = different kinds; shoe uppers = shoe uppers

Question 9: Some experimental shoes were banned because of the amount of ______ they produced.

Correct Answer: recoil
Accepted Answers: recoil
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "One such model produced so much recoil that officials banned it from competition"
Short Thai Explanation: คำตอบคือ recoil เพราะรองเท้ารุ่นนั้นถูกแบนจากแรงดีดกลับที่มากเกินไป.
Paraphrased Vocabulary: amount of = so much; banned = banned from competition

Question 10: Shoe adjustment is now considered as important as nutrition or ______ .

Correct Answer: training
Accepted Answers: training
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Today, shoe adjustment is considered by many coaches to be as important as nutrition or training."
Short Thai Explanation: คำตอบคือ training เพราะ passage เทียบ shoe adjustment กับ nutrition และ training.
Paraphrased Vocabulary: now = today; considered as important as = considered to be as important as

Question 11: Early running shoes were usually made from ______ .

Correct Answer: leather
Accepted Answers: leather
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "In the early days of modern running, most shoes were made from leather."
Short Thai Explanation: คำตอบคือ leather เพราะ passage บอกว่ารองเท้ายุคแรกส่วนใหญ่ทำจากหนัง.
Paraphrased Vocabulary: early running shoes = early days of modern running; usually = most

Question 12: Mateo Ruiz had extra steel ______ added to the front of his shoes.

Correct Answer: pins
Accepted Answers: pins
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Mateo Ruiz once had three additional steel pins placed near the front of each shoe"
Short Thai Explanation: คำตอบคือ pins เพราะเขาเพิ่ม steel pins ที่ด้านหน้ารองเท้า.
Paraphrased Vocabulary: extra = additional; added to the front = placed near the front

Question 13: Sofia Almeida changed the ______ on her shoes because the original ones were uncomfortable.

Correct Answer: laces
Accepted Answers: laces
Answer Group: IELTS Academic Reading June 2026 Passage 1 - How running shoes have changed
Exact Portion: "Sofia Almeida replaced the original laces in her shoes with thinner elastic ones because the standard version created pressure across the top of her foot."
Short Thai Explanation: คำตอบคือ laces เพราะเธอเปลี่ยนเชือกรองเท้าเดิมเพราะมันกดทับด้านบนเท้า.
Paraphrased Vocabulary: changed = replaced; uncomfortable = created pressure`
  },
  {
    id: 'builtin-reading-june-2026-passage-2-ancient-trade-raiders',
    title: 'IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes',
    category: 'normal',
    collectionTitle: 'IELTS Academic Reading June 2026',
    releaseAt: '2026-06-19T17:00:00.000Z',
...
In the first centuries BCE and CE, raiders threatened caravans travelling across the deserts and mountains of Central Asia.

A

When people imagine the ancient trade routes between East and West, they often picture peaceful caravans of camels carrying silk, spices and precious stones across a silent desert. Yet for much of antiquity, these routes were far from safe. Raiders attacked merchants, stole animals and goods, and then disappeared into regions that armies found difficult to enter. Despite the power of several ancient states, raiding remained a persistent problem for centuries. Only when attacks began to threaten the income and political authority of a major empire did rulers organise a large campaign to suppress the raiders and secure the roads.

B

The geography of Central Asia gave raiders many advantages. Much of the region consisted of deserts, mountains and narrow valleys. Farming was possible in some oases, but many communities depended more heavily on herding, hunting and trade than on agriculture. These people had excellent knowledge of wells, seasonal tracks and hidden passes. Caravans, by contrast, had to follow routes where water could be found. Before improved mapping and long-distance navigation, most merchant groups could not simply cross unknown desert. They were forced to remain close to established wells and oases, which made their movements predictable. If soldiers were sent after the raiders, local knowledge helped them escape capture.

C

It should also be remembered that ancient governments did not always regard raiders as enemies. During wars, rulers sometimes hired them as scouts, guides or mounted fighters. Their ability to move quickly through difficult country made them useful in the first stage of a campaign. Some oasis towns even allowed raiding groups to stay nearby. In return, the raiders brought stolen animals and goods to local markets, which increased trade and provided extra income for the town.

D

One of the earliest written records of a named raiding group appears in letters exchanged between an eastern emperor and the ruler of the oasis state of Yutian. The emperor complained that a group known as the Black Ridge Riders had attacked caravans carrying tax goods. He also suggested that Yutian had secretly supported them. The ruler of Yutian denied any involvement and insisted that none of his officials had helped the raiders. He promised to punish any subject who could be proved guilty of assisting them.

E

Attitudes towards raiding were not the same everywhere. In some settled states, raiders were condemned as criminals who damaged trade. Among certain desert communities, however, successful raids were sometimes admired as proof of courage and skill. Several ancient poems from the region praise riders who crossed dangerous land, seized wealthy caravans and returned with honour. Even officials were not always innocent. According to one later chronicle, a governor responsible for protecting a trade road once left his official route in order to capture a merchant caravan for his own profit.

F

The growing power of the eastern empire eventually made the problem impossible to ignore. At first, the state had benefited indirectly from raiding. Captured animals were sold in border markets, and some prisoners were forced to work on farms and building projects. This arrangement could continue only while the raiders avoided imperial interests. When they began attacking caravans carrying grain to frontier garrisons, officials at court demanded punishment. Even then, the government delayed action. The raiders became bolder, and by the first century CE they were kidnapping important envoys and demanding a ransom before releasing them.

G

A new law finally gave General Han Rui the money and authority needed to deal with the threat. Rather than sending one large army into the desert, Han Rui divided the trade route into twelve sectors. Each sector was assigned a commander, a small cavalry force and responsibility for guarding nearby wells. Once one sector had been cleared, its soldiers moved on to assist the next. Some raiders were killed in battle, but others were offered land in irrigated districts far from the caravan roads. This policy helped turn former raiders into farmers and reduced the chance that they would return to their old way of life.
...
C. They paid merchants for information about where valuable caravans would travel.
D. Some relied more on herding and trade than on farming.
E. They kept most stolen goods in mountain caves until they could be sold.
...
C. Some high-ranking officials were known to take part in raiding.
D. Every poem from the region criticised attacks on merchant caravans.
E. A positive view of raiding can be found in some ancient poems.
...
Accepted Answers: G
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "Han Rui divided the trade route into twelve sectors. Each sector was assigned a commander, a small cavalry force and responsibility for guarding nearby wells."
Short Thai Explanation: คำตอบคือ G เพราะย่อหน้านี้อธิบายวิธีจัด campaign เช่นแบ่งเส้นทางเป็น 12 sector และตั้ง commander.
Paraphrased Vocabulary: campaign organised = divided the trade route into sectors; stop raiding = deal with the threat

Question 16: a mention of the circumstances in which ancient states would make use of raiders

Correct Answer: C
Accepted Answers: C
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "During wars, rulers sometimes hired them as scouts, guides or mounted fighters."
...
Accepted Answers: A
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "When people imagine the ancient trade routes between East and West, they often picture peaceful caravans of camels carrying silk, spices and precious stones across a silent desert."
...
Accepted Answers: G
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "others were offered land in irrigated districts far from the caravan roads. This policy helped turn former raiders into farmers and reduced the chance that they would return to their old way of life."
Short Thai Explanation: คำตอบคือ G เพราะอดีต raiders ได้รับที่ดินทำเกษตร เพื่อให้เปลี่ยนเป็น farmers และไม่กลับไปปล้นอีก.
Paraphrased Vocabulary: encouraged not to return = reduced the chance that they would return; raiding = old way of life

Question 19: a mention of the need for many caravans to stay close to places where water was available

Correct Answer: B
Accepted Answers: B
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "They were forced to remain close to established wells and oases"
...
Accepted Answers: B
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "If soldiers were sent after the raiders, local knowledge helped them escape capture."
...
Accepted Answers: D
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "many communities depended more heavily on herding, hunting and trade than on agriculture"
...
Accepted Answers: C
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "a governor responsible for protecting a trade road once left his official route in order to capture a merchant caravan for his own profit."
...
Accepted Answers: E
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "Several ancient poems from the region praise riders who crossed dangerous land, seized wealthy caravans and returned with honour."
Short Thai Explanation: ข้อ E ถูก เพราะบทกวีโบราณบางบทชื่นชม riders ที่ปล้น caravan แล้วกลับมาพร้อมเกียรติ.
Paraphrased Vocabulary: positive view = praise; ancient poems = ancient poems

Question 24: attacks on caravans transporting ______ to frontier garrisons

Correct Answer: grain
Accepted Answers: grain
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "When they began attacking caravans carrying grain to frontier garrisons"
Short Thai Explanation: คำตอบคือ grain เพราะ caravan ที่ถูกโจมตีขน grain ไปยัง frontier garrisons.
Paraphrased Vocabulary: transporting = carrying

Question 25: officials demanded ______ for the raiders responsible

Correct Answer: punishment
Accepted Answers: punishment
Answer Group: IELTS Academic Reading June 2026 Passage 2 - The raiders of the ancient trade routes
Exact Portion: "officials at court demanded punishment"
Short Thai Explanation: คำตอบคือ punishment เพราะ officials เรียกร้องให้ลงโทษ raiders.
Paraphrased Vocabulary: demanded = demanded; responsible raiders = raiders responsible

Question 26: demanded a ______ before allowing them to return
