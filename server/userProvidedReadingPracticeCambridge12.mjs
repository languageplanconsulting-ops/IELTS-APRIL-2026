export const USER_PROVIDED_READING_PRACTICE_CAMBRIDGE_12_EXAMS = [
  {
    "id": "cambridge-12-test1-passage1",
    "title": "Cambridge 12 Test 1 Passage 1 - Cork",
    "category": "normal",
      ...
      "passages": [
        {
          ...
          "questions": [
            {
              "number": 1,
              "prompt": "The cork oak has the thickest bark of",
              "correctAnswer": "NOT GIVEN",
              "acceptedAnswers": [
                "NOT GIVEN"
              ],
              "answerGroup": "Cambridge 12 Test 1 Passage 1",
              "answerType": "true-false-not-given",
              "exactPortion": "Cork – the thick bark of the cork oak tree (Quercus suber) – is a remarkable material.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"Cork – the thick bark of the cork oak tree (Quercus suber) – is a remarkable material…\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "thickest = thick quercus suber = NOT GIVEN"
            },
            {
              "number": 2,
              "prompt": "Scientists have developed a synthetic cork with the same cellular structure",
              "correctAnswer": "FALSE",
              "acceptedAnswers": [
                "FALSE"
              ],
              "answerGroup": "Cambridge 12 Test 1 Passage 1",
              "answerType": "true-false-not-given",
              "exactPortion": "Developed most probably as a defence against forest fires, the bark of the cork oak has a particular cellular structure – with about 40 million cells per cubic centimetre – that technology has never succeeded in replicating.",
              "explanationThai": "บทความระบุว่า \"Developed most probably as a defence against forest fires, the bark of the cork oak h…\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "scientists developed synthetic = developed probably defence = FALSE"
            },
            {
              "number": 3,
              "prompt": "Individual cork oak trees must be left for 25 years between the first",
              "correctAnswer": "FALSE",
              "acceptedAnswers": [
                "FALSE"
              ],
              ...
              "exactPortion": "Developed most probably as a defence against forest fires, the bark of the cork oak has a particular cellular structure – with about 40 million cells per cubic centimetre – that technology has never succeeded in replicating.",
              "explanationThai": "บทความระบุว่า \"Developed most probably as a defence against forest fires, the bark of the cork oak h…\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "individual trees years = developed probably defence = FALSE"
            },
            {
              "number": 4,
              "prompt": "Cork bark should be stripped in dry",
              "correctAnswer": "TRUE",
              "acceptedAnswers": [
                "TRUE"
              ],
              ...
              "answerType": "true-false-not-given",
              "exactPortion": "Cork – the thick bark of the cork oak tree (Quercus suber) – is a remarkable material.",
              "explanationThai": "บทความระบุว่า \"Cork – the thick bark of the cork oak tree (Quercus suber) – is a remarkable material…\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "should stripped = thick quercus suber = TRUE"
            },
            {
              "number": 5,
              ...
              "exactPortion": "Cork – the thick bark of the cork oak tree (Quercus suber) – is a remarkable material.",
              "explanationThai": "บทความระบุว่า \"Cork – the thick bark of the cork oak tree (Quercus suber) – is a remarkable material…\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "remove trees = thick quercus suber = TRUE"
            },
            {
              "number": 6,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 1",
              "answerType": "text",
              "exactPortion": "The tiniest concentrations – as little as three or four parts to a trillion – can spoil the taste of the product contained in the bottle.",
              "explanationThai": "บทความบอกว่าสาร TCA ใน cork อาจทำให้รสชาติในขวดเสีย แต่ฝาแก้วและฝาสกรูไม่กระทบรสดังกล่าว คำว่า do not affect ในข้อจึงสอดคล้องกับ spoil the taste (ในทางตรงข้าม) จึงเติม taste",
              "paraphrasedVocabulary": "affect = spoil (negated) = taste = รสชาติ"
            },
            {
              "number": 7,
              ...
              "explanationThai": "ข้อเปรียบเทียบฝาทดแทนว่าพลาสติกและอลูมิเนียม cheaper to manufacture กว่า cork คำว่า are … to produce ในข้อจึงตรงกับ cheaper",
              "paraphrasedVocabulary": "produce = manufacture = cheaper = ถูกกว่า"
            },
            {
              "number": 8,
              ...
              "answerType": "text",
              "exactPortion": "These substitutes are cheaper to manufacture and, in the case of screw caps, more convenient for the user.",
              "explanationThai": "บทความระบุว่าฝาสกรู more convenient for the user กว่า คำว่า are … to use จึงตรงกับ convenient",
              "paraphrasedVocabulary": "to use = for the user = convenient = สะดวก"
            },
            {
              "number": 9,
              ...
              "explanationThai": "ข้อดีของ cork คือ traditional image ที่เข้ากับ (in keeping with) สินค้าคุณภาพสูง คำว่า suit the … of quality products จึงตอบ image",
              "paraphrasedVocabulary": "suit = in keeping with = image = ภาพลักษณ์"
            },
            {
              "number": 10,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 1",
              "answerType": "text",
              "exactPortion": "Secondly – and very importantly – cork is a sustainable product that can be recycled without difficulty.",
              "explanationThai": "บทความเน้นว่า cork เป็น sustainable product ที่รีไซเคิลได้ คำว่า made from a … material จึงตอบ sustainable",
              "paraphrasedVocabulary": "material = sustainable = ยั่งยืน"
            },
            {
              "number": 11,
              ...
              "answerType": "text",
              "exactPortion": "Secondly – and very importantly – cork is a sustainable product that can be recycled without difficulty.",
              "explanationThai": "บทความบอกว่า cork can be recycled without difficulty คำว่า … easily ในข้อจึงตรงกับ recycled",
              "paraphrasedVocabulary": "easily = without difficulty = recycled"
            },
            {
              "number": 12,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 1",
              "answerType": "text",
              "exactPortion": "Moreover, cork forests are a resource which support local biodiversity, and prevent desertification in the regions where they are planted.",
              "explanationThai": "ป่า cork support local biodiversity คำว่า aid … ในข้อจึงตอบ biodiversity",
              "paraphrasedVocabulary": "aid = support = biodiversity"
            },
            {
              "number": 13,
              ...
              "answerType": "text",
              "exactPortion": "Moreover, cork forests are a resource which support local biodiversity, and prevent desertification in the regions where they are planted.",
              "explanationThai": "ป่า cork prevent desertification ในพื้นที่ที่ปลูก คำว่า stop … happening จึงตอบ desertification",
              "paraphrasedVocabulary": "stop = prevent = desertification"
            }
          ]
        }
      ],
  ...
  {
    "id": "cambridge-12-test1-passage2",
    "title": "Cambridge 12 Test 1 Passage 2 - Collecting as a Hobby",
    "category": "normal",
          ...
          "questions": [
            {
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "They'll look for, say, antiques that they can buy cheaply and expect to be able to sell at a profit.",
              "explanationThai": "ย่อหน้าแรกของเหตุผลเชิงเครื่องมือ (instrumental) ยกตัวอย่างการซื้อ antiques ราคาถูกแล้วขายทำกำไร คำว่า mentions … as an example of collecting to make money จึงตอบ antiques",
              "paraphrasedVocabulary": "make money = sell at a profit = antiques = ของโบราณ"
            },
            {
              "number": 15,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "But there may well be a psychological element, too – buying cheap and selling dear can give the collector a sense of triumph.",
              "explanationThai": "การซื้อถูกขายแพงให้ collector a sense of triumph คำว่า feeling of … จึงตอบ triumph",
              "paraphrasedVocabulary": "feeling = sense of = triumph = ชัยชนะ"
            },
            {
              "number": 16,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "Many collectors collect to develop their social life, attending meetings of a group of collectors and exchanging information on items.",
              "explanationThai": "ชมรมนักสะสมมีการ exchanging information on items คำว่า share … จึงตอบ information",
              "paraphrasedVocabulary": "share = exchanging = information = ข้อมูล"
            },
            {
              "number": 17,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "This is a variant on joining a bridge club or a gym, and similarly brings them into contact with like-minded people.",
              "explanationThai": "การเข้าร่วมกลุ่ม brings them into contact with like-minded people คำว่า offer … with people who have similar interests จึงตอบ contact",
              "paraphrasedVocabulary": "similar interests = like-minded = contact = ติดต่อ/พบปะ"
            },
            {
              "number": 18,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "Another motive for collecting is the desire to find something special, or a particular example of the collected item, such as a rare early recording by a particular singer.",
              "explanationThai": "บางคนมี desire to find something special และอาจใช้ชีวิตทั้งชีวิตในการ hunt คำว่า life-long … จึงตอบ desire (หรือ hunt ตามข้อความ)",
              "paraphrasedVocabulary": "life-long = whole lives = desire/hunt = ความปรารถนา/การล่า"
            },
            {
              "number": 19,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "Psychologically, this can give a purpose to a life that otherwise feels aimless.",
              "explanationThai": "การล่าหาของพิเศษทำให้ชีวิตที่มิฉะนั้นจะ feels aimless มีจุดหมาย คำว่า prevent … feeling life is completely … จึงตอบ aimless",
              "paraphrasedVocabulary": "prevent = otherwise feels = aimless = ไร้จุดหมาย"
            },
            {
              "number": 20,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "If you think about collecting postage stamps, another potential reason for it – or, perhaps, a result of collecting – is its educational value.",
              "explanationThai": "การสะสมแสตมป์มี educational value เพราะเปิดโลกทัศน์เกี่ยวกับประเทศต่างๆ คำว่า may be … จึงตอบ educational",
              "paraphrasedVocabulary": "facts about countries = educational value = การศึกษา"
            },
            {
              "number": 21,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "text",
              "exactPortion": "In the past – and nowadays, too, though to a lesser extent – a popular form of collecting, particularly among boys and men, was trainspotting.",
              "explanationThai": "trainspotting เป็นที่นิยม particularly among boys and men คำว่า … tends to be mostly a male hobby จึงตอบ trainspotting",
              "paraphrasedVocabulary": "male hobby = boys and men = trainspotting"
            },
            {
              "number": 22,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "These have changed over the centuries from the wood that was standard in 16th century Europe, through the wax and porcelain of later centuries, to the plastics of today's dolls.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"These have changed over the centuries from the wood that was standard in 16th century…\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "number buying dolls = changed centuries standard = NOT GIVEN"
            },
            {
              "number": 23,
              "prompt": "Sixteenth century European dolls were normally made of wax",
              "correctAnswer": "FALSE",
              "acceptedAnswers": [
                "FALSE"
              ],
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "Or collectors might be inspired to study how dolls reflect notions of what children like, or ought to like.",
              "explanationThai": "บทความระบุว่า \"Or collectors might be inspired to study how dolls reflect notions of what children l…\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "sixteenth century european = collectors might inspired = FALSE"
            },
            {
              "number": 24,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "in albums, usually very neatly, organising their collection according to certain commonplace principles – perhaps by country in alphabetical order, or grouping stamps by what they depict – people, birds, maps, and so on.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"in albums, usually very neatly, organising their collection according to certain comm…\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "arranging stamp collection = albums usually neatly = NOT GIVEN"
            },
            {
              "number": 25,
              "prompt": "Someone who collects unusual objects may want others to think he or she is",
              "correctAnswer": "TRUE",
              "acceptedAnswers": [
                "TRUE"
              ],
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "Many forms of collecting have been dignified with a technical name: an archtophilist collects teddy bears, a philatelist collects postage stamps, and a deltiologist collects postcards.",
              "explanationThai": "บทความระบุว่า \"Many forms of collecting have been dignified with a technical name: an archtophilist …\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "someone collects unusual = forms collecting dignified = TRUE"
            },
            {
              "number": 26,
              "prompt": "Collecting gives a feeling that other hobbies",
              "correctAnswer": "TRUE",
              "acceptedAnswers": [
                "TRUE"
              ],
              "answerGroup": "Cambridge 12 Test 1 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "More than most other hobbies, collecting can be totally engrossing, and can give a strong sense of personal fulfilment.",
              "explanationThai": "บทความระบุว่า \"More than most other hobbies, collecting can be totally engrossing, and can give a st…\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "collecting gives feeling = hobbies collecting totally = TRUE"
            }
          ]
        }
      ],
          ...
          "questions": [
            {
              ...
              "exactPortion": "But what would the founders of these two institutions have thought of a course called 'Arson for Profit'?",
              "explanationThai": "ชื่อวิชาแปลกที่มีจริง = heading vi เนื้อหาย่อหน้าที่เกี่ยวกับ \"Arson for Profit\" ตรงกับหัวข้อ vi มากที่สุด",
              "paraphrasedVocabulary": "surprising course title = Arson for Profit = ชื่อวิชาแปลก"
            },
            {
              "number": 28,
              "prompt": "Paragraph B",
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "But wouldn't this also be the perfect course for prospective arsonists to sign up for?",
              "explanationThai": "อาจดึงดูดนักวิชาการผิดประเภท เนื้อหาย่อหน้าที่เกี่ยวกับ \"perfect course for prospective arsonists\" ตรงกับหัวข้อ viii มากที่สุด",
              "paraphrasedVocabulary": "wrong kind of student = prospective arsonists"
            },
            {
              "number": 29,
              "prompt": "Paragraph C",
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Similarly, if you employed the 'principles of marketing' in an unprincipled way, you would not be doing marketing.",
              "explanationThai": "ชื่อวิชามีสองความหมายของ principles เนื้อหาย่อหน้าที่เกี่ยวกับ \"Principles of Marketing\" ตรงกับหัวข้อ ii มากที่สุด",
              "paraphrasedVocabulary": "two meanings = principled/ethical = สองความหมาย"
            },
            {
              "number": 30,
              "prompt": "Paragraph D",
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "My inspiration for this judgement is the philosopher Immanuel Kant, who argued that any body of knowledge consists of an end (or purpose) and a means.",
              "explanationThai": "นำทฤษฎี Kant มาใช้กับการตลาด เนื้อหาย่อหน้าที่เกี่ยวกับ \"Immanuel Kant\" ตรงกับหัวข้อ iv มากที่สุด",
              "paraphrasedVocabulary": "unexpected context = Kant + marketing"
            },
            {
              "number": 31,
              "prompt": "Paragraph E",
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "field of knowledge or a professional endeavor is defined by both the means and the end; hence both deserve scrutiny.",
              "explanationThai": "means และ end สำคัญเท่ากัน เนื้อหาย่อหน้าที่เกี่ยวกับ \"defined by both the means and the end\" ตรงกับหัวข้อ iii มากที่สุด",
              "paraphrasedVocabulary": "equal importance = both means and end"
            },
            {
              "number": 32,
              "prompt": "Paragraph F",
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "We would say that one is practicing medicine, the other, murder.",
              "explanationThai": "ชื่อต่างกันเมื่อจุดประสงค์ต่างกัน เนื้อหาย่อหน้าที่เกี่ยวกับ \"separate word for it: arson\" ตรงกับหัวข้อ vii มากที่สุด",
              "paraphrasedVocabulary": "different names = arson/fraud/murder"
            },
            {
              "number": 33,
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "text",
              "exactPortion": "Any undergraduates who have met the academic requirements can sign up for the course in our program in 'fire science'.",
              "explanationThai": "บทความระบุว่านักศึกษาลงทะเบียนใน program in 'fire science' คำว่า studying … ในสรุปจึงตอบ fire science",
              "paraphrasedVocabulary": "studying = program in = fire science"
            },
            {
              "number": 34,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "true-false-not-given",
              "exactPortion": "student can prepare for a career in resort management, engineering, interior design, accounting, music, law enforcement, you name it.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"student can prepare for a career in resort management, engineering, interior design, …\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "difficult = student prepare career = NOT GIVEN"
            },
            {
              "number": 38,
              ...
              "exactPortion": "But what would the founders of these two institutions have thought of a course called 'Arson for Profit'?",
              "explanationThai": "มุมมองของผู้เขียนสอดคล้องกับข้อนี้ โดยอ้างอิงจาก \"But what would the founders of these two institutions have thought of a course called…\" จึงตอบ YES",
              "paraphrasedVocabulary": "'arson profit' course = founders institutions thought = YES"
            },
            {
              "number": 39,
              "prompt": "Fire science courses",
              "correctAnswer": "NO",
              "acceptedAnswers": [
                "NO"
              ],
              "answerGroup": "Cambridge 12 Test 1 Passage 3",
              "answerType": "yes-no-not-given",
              "exactPortion": "However, it's not unknown for a firefighter to torch a building.",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"However, it's not unknown for a firefighter to torch a building.\" จึงตอบ NO",
              "paraphrasedVocabulary": "science courses = however unknown firefighter = NO"
            },
            {
              "number": 40,
              "prompt": "Fire science students provided a detailed definition of the purpose of their studies.",
              "correctAnswer": "NO",
              "acceptedAnswers": [
                "NO"
              ],
              ...
              "exactPortion": "However, it's not unknown for a firefighter to torch a building.",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"However, it's not unknown for a firefighter to torch a building.\" จึงตอบ NO",
              "paraphrasedVocabulary": "science students provided = however unknown firefighter = NO"
            }
          ]
        }
      ],
  ...
  },
  {
    ...
    "createdAt": "2026-05-15T00:00:00.000Z",
    "updatedAt": "2026-05-23T09:24:51.625Z",
    "parsedPayload": {
      "title": "Cambridge 12 Test 2 Passage 1 - The Risks Agriculture Faces in Developing Countries",
      "category": "normal",
      "passages": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "However, smallholder farmers in developing countries must in addition deal with adverse environments, both natural, in terms of soil quality, rainfall, etc., and human, in terms of infrastructure, financial systems, mark",
              "explanationThai": "ย่อหน้า B เกี่ยวกับเกษตรกรในประเทศกำลังพัฒนา ข้อความที่เกี่ยวกับ \"smallholder farmers in developing countries\" ชี้ไปที่ตัวเลือก B มากที่สุด",
              "paraphrasedVocabulary": "only = developing countries = เฉพาะบางภูมิภาค"
            },
            {
              "number": 3,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "According to Murphy, ‘collective action offers an important way for farmers to strengthen their political and economic bargaining power, and to reduce their business risks.’ One commentator, Giel Ton, warned that collect",
              "explanationThai": "ย่อหน้า H อธิบายว่า collective action does not come as a free good ต้องใช้เวลาและความพยายามในการสร้างความร่วมมือ จึงเป็นย่อหน้าที่พูดถึง difficulties in co-operation",
              "paraphrasedVocabulary": "co-operation = collective action = ความร่วมมือ"
            },
            {
              "number": 4,
            ...
            },
            {
              ...
              "answerType": "multiple-choice",
              "exactPortion": "According to Murphy, ‘collective action offers an important way for farmers to strengthen their political and economic bargaining power, and to reduce their business risks.’ One commentator, Giel Ton, warned that collect",
              "explanationThai": "Murphy ว่าการร่วมมือช่วยเพิ่มอำนาจต่อรอง ข้อความที่เกี่ยวกับ \"collective action offers an important way\" ชี้ไปที่ตัวเลือก B มากที่สุด",
              "paraphrasedVocabulary": "collaborating = collective action = ร่วมมือกลุ่ม"
            },
            {
              "number": 6,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Shenggen Fan, Director General of the International Food Policy Research Institute, held up social safety nets and public welfare programmes in Ethiopia, Brazil and Mexico as valuable ways to address poverty among farmin",
              "explanationThai": "Fan ว่า safety nets ช่วยลดความยากจน ข้อความที่เกี่ยวกับ \"address poverty among farming families\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "standard of living = address poverty = ระดับชีวิต"
            },
            {
              "number": 7,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Similarly, Sonali Bisht, founder and advisor to the Institute of Himalayan Environmental Research and Education (INHERE), India, wrote that community-supported agriculture, where consumers invest in local farmers by subs",
              "explanationThai": "ผู้บริโภคลงทุนกับเกษตรกรโดยตรง ข้อความที่เกี่ยวกับ \"consumers invest in local farmers by subscription\" ชี้ไปที่ตัวเลือก G มากที่สุด",
              "paraphrasedVocabulary": "financial input = invest by subscription = ลงทุน"
            },
            {
              "number": 8,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Sophia Murphy, senior advisor to the Institute for Agriculture and Trade Policy, suggested that the procurement and holding of stocks by governments can also help mitigate wild swings in food prices by alleviating uncert",
              "explanationThai": "Murphy ว่ารัฐเก็บสต็อกช่วยลดความผันผวนราคา ข้อความที่เกี่ยวกับ \"mitigate wild swings in food prices\" ชี้ไปที่ตัวเลือก B มากที่สุด",
              "paraphrasedVocabulary": "variation in prices = wild swings = ความผันผวน"
            },
            {
              "number": 9,
              "prompt": "Improvements to infrastructure can have a major impact on risk for farmers. Questions 10-11 Which TWO problems affect farmers with small farms in developing countries? Questions 12-13 Which TWO actions are recommended for improving conditions for farmers?",
              "correctAnswer": "A",
              "acceptedAnswers": [
                "A"
              ],
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Nwanze, President of the International Fund for Agricultural Development, argued that governments can significantly reduce risks for farmers by providing basic services like roads to get produce more efficiently to marke",
              "explanationThai": "Nwanze ว่าโครงสร้างพื้นฐานลดความเสี่ยง ข้อความที่เกี่ยวกับ \"providing basic services like roads\" ชี้ไปที่ตัวเลือก A มากที่สุด",
              "paraphrasedVocabulary": "infrastructure = basic services like roads = โครงสร้างพื้นฐาน"
            },
            {
              "number": 10,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Fan explained that ‘in addition to reducing crop yields, climate change increases the magnitude and frequency of extreme weather events, which increase smallholder vulnerability.’ The growing unpredictability of weather ",
              "explanationThai": "ปัญหาหนึ่งคือสภาพอากาศเปลี่ยนแปลง ข้อความที่เกี่ยวกับ \"climate change increases the magnitude and frequency of extreme weather\" ชี้ไปที่ตัวเลือก D มากที่สุด",
              "paraphrasedVocabulary": "changing weather = extreme weather = สภาพอากาศ"
            },
            {
              "number": 11,
            ...
            },
            {
              ...
              "answerType": "multiple-choice",
              "exactPortion": "Similarly, Sonali Bisht, founder and advisor to the Institute of Himalayan Environmental Research and Education (INHERE), India, wrote that community-supported agriculture, where consumers invest in local farmers by subs",
              "explanationThai": "แบบ community-supported agriculture ข้อความที่เกี่ยวกับ \"consumers invest in local farmers by subscription\" ชี้ไปที่ตัวเลือก D มากที่สุด",
              "paraphrasedVocabulary": "financial stake = invest by subscription = ลงทุนร่วม"
            }
          ]
        }
      ],
  ...
  {
    "id": "cambridge-12-test2-passage2",
    "title": "Cambridge 12 Test 2 Passage 2 - The Lost City",
    "category": "normal",
          ...
          "questions": [
            {
              ...
              "answerType": "multiple-choice",
              "exactPortion": "His goal was to locate the remains of a city called Vitcos, the last capital of the Inca civilisation.",
              "explanationThai": "เป้าหมายการเดินทาง เนื้อหาย่อหน้าที่เกี่ยวกับ \"His goal was to locate the remains of a city called Vitcos\" ตรงกับหัวข้อ iv มากที่สุด",
              "paraphrasedVocabulary": "aim = goal = iv"
            },
            {
              "number": 15,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "When Bingham and his team set off down the Urubamba in late July, they had an advantage over travelers who had preceded them: a track had recently been blasted down the valley canyon to enable rubber to be brought up by ",
              "explanationThai": "เส้นทางใหม่ เนื้อหาย่อหน้าที่เกี่ยวกับ \"a track had recently been blasted down the valley\" ตรงกับหัวข้อ vi มากที่สุด",
              "paraphrasedVocabulary": "new route = track recently blasted = vi"
            },
            {
              "number": 16,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "His companions showed no interest in accompanying him up the nearby hill to see some ruins that a local farmer, Melchor Arteaga, had told them about the night before.",
              "explanationThai": "Bingham ไม่กระตือรือร้น เนื้อหาย่อหน้าที่เกี่ยวกับ \"showed no interest\" ตรงกับหัวข้อ viii มากที่สุด",
              "paraphrasedVocabulary": "lack of enthusiasm = no interest = viii"
            },
            {
              "number": 17,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "First, as he climbs up the hill, he describes the ever-present possibility of deadly snakes, ‘capable of making considerable springs when in pursuit of their prey’; not that he sees any.",
              "explanationThai": "บรรยายอย่างตื่นเต้น เนื้อหาย่อหน้าที่เกี่ยวกับ \"describes the ever-present possibility of deadly snakes\" ตรงกับหัวข้อ v มากที่สุด",
              "paraphrasedVocabulary": "dramatic description = vivid style = v"
            },
            {
              "number": 18,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "When he came to write the National Geographic magazine article that broke the story to the world in April 1913, he knew he had to produce a big idea.",
              "explanationThai": "ตีพิมพ์ทฤษฎี เนื้อหาย่อหน้าที่เกี่ยวกับ \"he knew he had to produce a big idea\" ตรงกับหัวข้อ vii มากที่สุด",
              "paraphrasedVocabulary": "publishes theory = big idea for magazine = vii"
            },
            {
              "number": 20,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "An idea which has gained wide acceptance over the past few years is that Machu Picchu was a moya, a country estate built by an Inca emperor to escape the cold winters of Cusco, where the elite could enjoy monumental arch",
              "explanationThai": "ความเชื่อที่ยอมรับกว้าง เนื้อหาย่อหน้าที่เกี่ยวกับ \"An idea which has gained wide acceptance\" ตรงกับหัวข้อ iii มากที่สุด",
              "paraphrasedVocabulary": "common belief = wide acceptance = iii"
            },
            {
              "number": 21,
              "prompt": "Bingham went to South",
              "correctAnswer": "TRUE",
              "acceptedAnswers": [
                "TRUE"
              ],
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "isation   When the US explorer and academic Hiram Bingham arrived in South America in 1911, he was ready for what was to be the greatest achievement of his life: the exploration of the remote hinterland to the west of Cusco, the old capital",
              "explanationThai": "บทความระบุว่า \"isation   When the US explorer and academic Hiram Bingham arrived in South America in…\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "bingham south = isation explorer academic = TRUE"
            },
            {
              "number": 22,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "Almost all previous travelers had left the river at Ollantaytambo and taken a high pass across the mountains to rejoin the river lower down, thereby cutting a substantial corner, but also therefore never passing through the area around Mach",
              "explanationThai": "บทความระบุว่า \"Almost all previous travelers had left the river at Ollantaytambo and taken a high pa…\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "bingham chose route = almost previous travelers = FALSE"
            },
            {
              "number": 23,
              "prompt": "Bingham understood the significance",
              "correctAnswer": "FALSE",
              "acceptedAnswers": [
                "FALSE"
              ],
              ...
              "exactPortion": "Almost all previous travelers had left the river at Ollantaytambo and taken a high pass across the mountains to rejoin the river lower down, thereby cutting a substantial corner, but also therefore never passing through the area around Mach",
              "explanationThai": "บทความระบุว่า \"Almost all previous travelers had left the river at Ollantaytambo and taken a high pa…\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "bingham understood significance = almost previous travelers = FALSE"
            },
            {
              "number": 24,
              ...
              "answerType": "true-false-not-given",
              "exactPortion": "isation   When the US explorer and academic Hiram Bingham arrived in South America in 1911, he was ready for what was to be the greatest achievement of his life: the exploration of the remote hinterland to the west of Cusco, the old capital",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"isation   When the US explorer and academic Hiram Bingham arrived in South America in…\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "bingham returned evidence = isation explorer academic = NOT GIVEN"
            },
            {
              "number": 25,
              ...
              "answerType": "text",
              "exactPortion": "When Bingham and his team set off down the Urubamba in late July, they had an advantage over travelers who had preceded them: a track had recently been blasted down the valley canyon to enable rubber to be brought up by ",
              "explanationThai": "เส้นทางถูกเปิดเพื่อ enable rubber to be brought up by mules คำว่า transportation of … จึงตอบ rubber",
              "paraphrasedVocabulary": "transportation = brought up = rubber = ยาง"
            },
            {
              "number": 26,
              ...
              "answerType": "text",
              "exactPortion": "His companions showed no interest in accompanying him up the nearby hill to see some ruins that a local farmer, Melchor Arteaga, had told them about the night before.",
              "explanationThai": "Bingham ได้ยินข่าวซากจาก a local farmer, Melchor Arteaga คำว่า found out … from a … จึงตอบ farmer",
              "paraphrasedVocabulary": "from a = local farmer = ชาวนา"
            }
          ]
        }
      ],
      ...
      "passages": [
        {
          ...
          "questions": [
            ...
            },
            {
              ...
              "explanationThai": "การทดลองอ้างถึง In the classic Stroop Task คำว่า A test called the … จึงตอบ Stroop Task",
              "paraphrasedVocabulary": "test = Stroop Task"
            },
            {
              "number": 30,
              ...
              "explanationThai": "ผู้พูดสองภาษา perform better on tasks that require conflict management คำว่า more able to handle … จึงตอบ conflict management",
              "paraphrasedVocabulary": "handle = conflict management"
            },
            {
              "number": 31,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 3",
              "answerType": "yes-no-not-given",
              "exactPortion": "In a study of over 200 patients with Alzheimer’s disease, a degenerative brain disease, bilingual patients reported showing initial symptoms of the disease an average of five years later than monolingual patients.",
              "explanationThai": "มุมมองของผู้เขียนสอดคล้องกับข้อนี้ โดยอ้างอิงจาก \"In a study of over 200 patients with Alzheimer’s disease, a degenerative brain diseas…\" จึงตอบ YES",
              "paraphrasedVocabulary": "attitudes towards bilingualism = study patients alzheimer = YES"
            },
            {
              "number": 33,
              "prompt": "Bilingual people",
              "correctAnswer": "NOT GIVEN",
              "acceptedAnswers": [
                "NOT GIVEN"
              ],
              ...
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"According to the latest figures, the majority of the world’s population is now biling…\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "bilingual = according latest figures = NOT GIVEN"
            },
            {
              "number": 34,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 3",
              "answerType": "yes-no-not-given",
              "exactPortion": "For instance, knowing more than one language can cause speakers to name pictures more slowly, and can increase ‘tip-of-the-tongue states’, when you can almost, but not quite, bring a word to mind.",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"For instance, knowing more than one language can cause speakers to name pictures more…\" จึงตอบ NO",
              "paraphrasedVocabulary": "bilingual consistently images = instance knowing language = NO"
            },
            {
              "number": 35,
              "prompt": "Bilingual people's brains process single sounds more efficiently in",
              "correctAnswer": "NO",
              "acceptedAnswers": [
                "NO"
              ],
              "answerGroup": "Cambridge 12 Test 2 Passage 3",
              "answerType": "yes-no-not-given",
              "exactPortion": "For bilingual people, this activation is not limited to a single language; auditory input activates corresponding words regardless of the language to which they belong.",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"For bilingual people, this activation is not limited to a single language; auditory i…\" จึงตอบ NO",
              "paraphrasedVocabulary": "bilingual people's brains = bilingual activation limited = NO"
            },
            {
              "number": 36,
              ...
              "answerType": "true-false-not-given",
              "exactPortion": "In a study of over 200 patients with Alzheimer’s disease, a degenerative brain disease, bilingual patients reported showing initial symptoms of the disease an average of five years later than monolingual patients.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"In a study of over 200 patients with Alzheimer’s disease, a degenerative brain diseas…\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "fewer bilingual monolingual = study patients alzheimer = NOT GIVEN"
            },
            {
              "number": 37,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "When monolingual and bilingual adolescents listen to simple speech sounds without any intervening background noise, they show highly similar brain stem responses.",
              "explanationThai": "ย่อหน้า D เปรียบเทียบเมื่อมีเสียงรบกวน ข้อความที่เกี่ยวกับ \"listen to simple speech sounds\" ชี้ไปที่ตัวเลือก D มากที่สุด",
              "paraphrasedVocabulary": "non-verbal auditory = speech sounds = เสียง"
            },
            {
              "number": 38,
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "In one study, researchers taught seven-month-old babies growing up in monolingual or bilingual homes that when they heard a tinkling sound, a puppet appeared on one side of a screen.",
              "explanationThai": "ทารก 7 เดือน ข้อความที่เกี่ยวกับ \"seven-month-old babies growing up in monolingual or bilingual homes\" ชี้ไปที่ตัวเลือก G มากที่สุด",
              "paraphrasedVocabulary": "before we learn to speak = seven-month-old = ก่อนพูด"
            },
            {
              "number": 39,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 2 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Having to deal with this persistent linguistic competition can result in difficulties, however.",
              "explanationThai": "มีข้อเสียบางอย่าง ข้อความที่เกี่ยวกับ \"can result in difficulties\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "negative consequences = difficulties = ข้อเสีย"
            }
          ]
        }
      ],
  ...
  },
  {
    ...
    "createdAt": "2026-05-15T00:00:00.000Z",
    "updatedAt": "2026-05-23T09:24:51.626Z",
    "parsedPayload": {
      "title": "Cambridge 12 Test 3 Passage 1 - Flying Tortoises",
      "category": "normal",
      "passages": [
          ...
          "questions": [
            {
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Some time after the Galápagos’s birth, around five million years ago, the islands were colonised by one or more tortoises from mainland South America.",
              "explanationThai": "เต่าเข้ามาอาศัยเกาะ เนื้อหาย่อหน้าที่เกี่ยวกับ \"islands were colonised by one or more tortoises\" ตรงกับหัวข้อ v มากที่สุด",
              "paraphrasedVocabulary": "populate = colonised = v"
            },
            {
              "number": 2,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "From the 17th century onwards, pirates took a few on board for food, but the arrival of whaling ships in the 1790s saw this exploitation grow exponentially.",
              "explanationThai": "การล่าและทำลายประชากร เนื้อหาย่อหน้าที่เกี่ยวกับ \"pirates took a few\" ตรงกับหัวข้อ iii มากที่สุด",
              "paraphrasedVocabulary": "disadvantage = exploitation = iii"
            },
            {
              "number": 3,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "In 1989, work began on a tortoise-breeding centre just outside the town of Puerto Villamil on Isabela, dedicated to protecting the island’s tortoise populations.",
              "explanationThai": "เริ่มโครงการอนุรักษ์ เนื้อหาย่อหน้าที่เกี่ยวกับ \"tortoise-breeding centre\" ตรงกับหัวข้อ viii มากที่สุด",
              "paraphrasedVocabulary": "conservation project = breeding centre = viii"
            },
            {
              "number": 4,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Flying tortoises An airborne reintroduction programme has helped conservationists take significant steps to protect the endangered Galápagos tortoise.",
              "explanationThai": "ต้องรอให้ถึงอายุที่ปลอดภัย เนื้อหาย่อหน้าที่เกี่ยวกับ \"can't be reintroduced until they're at least five years old\" ตรงกับหัวข้อ i มากที่สุด",
              "paraphrasedVocabulary": "timing right = at least five years old = i"
            },
            {
              "number": 5,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "But in November 2010, the environmentalist and Galápagos National Park liaison officer Godfrey Merlin, a visiting private motor yacht captain and a helicopter pilot gathered around a table in a small café in Puerto Ayora",
              "explanationThai": "วางแผนย้าย 300 ตัว เนื้อหาย่อหน้าที่เกี่ยวกับ \"work out more ambitious reintroduction\" ตรงกับหัวข้อ iv มากที่สุด",
              "paraphrasedVocabulary": "bigger idea = more ambitious = iv"
            },
            {
              "number": 6,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "The aim was to use a helicopter to move 300 of the breeding centre’s tortoises to various locations close to Sierra Negra.",
              "explanationThai": "ดำเนินการอย่างพิถีพิถัน เนื้อหาย่อหน้าที่เกี่ยวกับ \"helicopter to move\" ตรงกับหัวข้อ vi มากที่สุด",
              "paraphrasedVocabulary": "carefully prepared operation = helicopter operation = vi"
            },
            {
              "number": 7,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "multiple-choice",
              "exactPortion": "Eventually, one tiny tortoise came across a fully grown giant who had been lumbering around the island for around a hundred years.",
              "explanationThai": "เจอเต่าตัวใหญ่ เนื้อหาย่อหน้าที่เกี่ยวกับ \"one tiny tortoise came across a fully grown giant\" ตรงกับหัวข้อ ii มากที่สุด",
              "paraphrasedVocabulary": "young meets old = tiny tortoise and giant = ii"
            },
            {
              "number": 8,
              ...
              "answerType": "text",
              "exactPortion": "From the 17th century onwards, pirates took a few on board for food, but the arrival of whaling ships in the 1790s saw this exploitation grow exponentially.",
              "explanationThai": "ตั้งแต่ศตวรรษที่ 17 pirates took a few tortoises on board คำว่า ships used by … จึงตอบ pirates",
              "paraphrasedVocabulary": "ships used by = pirates took = โจรสลัด"
            },
            {
              "number": 9,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "text",
              "exactPortion": "Relatively immobile and capable of surviving for months without food or water, the tortoises were taken on board these ships to act as food supplies during long ocean passages.",
              "explanationThai": "เต่าถูกเก็บเป็น food supplies ระหว่างเดินทางทะเลยาว คำว่า kept for … จึงตอบ food",
              "paraphrasedVocabulary": "kept for = food supplies = อาหาร"
            },
            {
              "number": 10,
              ...
              "explanationThai": "ร่างเต่าถูก processed into high-grade oil คำว่า used to produce … จึงตอบ oil",
              "paraphrasedVocabulary": "produce = processed into = oil = น้ำมัน"
            },
            {
              "number": 11,
              ...
              "answerType": "text",
              "exactPortion": "Flying tortoises An airborne reintroduction programme has helped conservationists take significant steps to protect the endangered Galápagos tortoise.",
              "explanationThai": "เมื่อ settlers มาถึงเกาะ พวกเขา hunted the tortoises คำว่า Hunted by … จึงตอบ settlers",
              "paraphrasedVocabulary": "hunted by = settlers hunted = ผู้บุกเบิก"
            },
            {
              "number": 12,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 1",
              "answerType": "text",
              "exactPortion": "They also introduced alien species – ranging from cattle, pigs, goats, rats and dogs to plants and ants – that either prey on the eggs and young tortoises or damage or destroy their habitat.",
              "explanationThai": "มีการนำ introduced alien species เข้ามา คำว่า by various … not native จึงตอบ species",
              "paraphrasedVocabulary": "not native = alien species = species"
            },
            {
              "number": 13,
              ...
              "answerType": "text",
              "exactPortion": "They also introduced alien species – ranging from cattle, pigs, goats, rats and dogs to plants and ants – that either prey on the eggs and young tortoises or damage or destroy their habitat.",
              "explanationThai": "สัตว์ต่างถิ่น prey on the eggs and young tortoises คำว่า fed on … eggs จึงตอบ eggs",
              "paraphrasedVocabulary": "fed on = prey on = eggs = ไข่"
            }
          ]
        }
      ],
  ...
  {
    "id": "cambridge-12-test3-passage2",
    "title": "Cambridge 12 Test 3 Passage 2 - The Intersection of Health Sciences and Geography",
    "category": "normal",
          ...
          "questions": [
            {
              ...
              "answerType": "multiple-choice",
              "exactPortion": "While people will always be prone to illness, the study of how geography affects our health could lead to the eradication of certain illnesses, and the prevention of others in the future.",
              "explanationThai": "ไม่สามารถกำจัดทุกโรคได้ ข้อความที่เกี่ยวกับ \"lead to the eradication of certain illnesses, and the prevention of others\" ชี้ไปที่ตัวเลือก D มากที่สุด",
              "paraphrasedVocabulary": "not all eliminated = eradication of certain illnesses = บางโรค"
            },
            {
              "number": 15,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "In many large cities, the wind is not strong enough to clear the air of the massive amounts of smog and pollution that cause asthma, lung problems, eyesight issues and more in the people who live there.",
              "explanationThai": "มลพิษจากพฤติกรรมมนุษย์ ข้อความที่เกี่ยวกับ \"asthma, lung problems, eyesight issues\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "physical conditions = asthma, lung problems = สภาพทางกาย"
            },
            {
              "number": 16,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "Researchers study the interactions between humans and their environment that could lead to illness (such as asthma in places with high levels of pollution) and work to create a clear way of categorizing illnesses, diseas",
              "explanationThai": "จำแนกตามขอบเขตภูมิศาสตร์ ข้อความที่เกี่ยวกับ \"categorizing illnesses, diseases and epidemics into local and global scales\" ชี้ไปที่ตัวเลือก F มากที่สุด",
              "paraphrasedVocabulary": "classifying = categorizing into local and global"
            },
            {
              "number": 17,
              "prompt": "reasons why access to healthcare can vary within",
              "correctAnswer": "G",
              "acceptedAnswers": [
                "G"
              ],
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "In both developed and developing nations there is often a very large discrepancy between the options available to people in different social classes, income brackets, and levels of education.",
              "explanationThai": "ความไม่เท่าเทียมในประเทศ ข้อความที่เกี่ยวกับ \"discrepancy between the options available to people in different social classes\" ชี้ไปที่ตัวเลือก G มากที่สุด",
              "paraphrasedVocabulary": "vary = discrepancy = social classes"
            },
            {
              "number": 18,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "Malaria is much less of a problem in high-altitude deserts, for instance.",
              "explanationThai": "มาลาเรียหายากในทะเลทราย ข้อความที่เกี่ยวกับ \"Malaria is much less of a problem in high-altitude deserts\" ชี้ไปที่ตัวเลือก B มากที่สุด",
              "paraphrasedVocabulary": "rare = much less of a problem = หายาก"
            },
            {
              "number": 20,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "text",
              "exactPortion": "As a result, super-viruses and other infections resistant to antibiotics are becoming more and more common.",
              "explanationThai": "มี super-viruses resistant to antibiotics ทำให้ยาปฏิชีวนะเสียประสิทธิภาพ คำว่า … are losing their usefulness จึงตอบ antibiotics",
              "paraphrasedVocabulary": "losing usefulness = resistant to = antibiotics"
            },
            {
              "number": 22,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "text",
              "exactPortion": "Perhaps one of the most obvious examples of this idea is malaria-prone areas, which are usually tropical regions that foster a warm and damp environment in which the mosquitos that can give people this disease can grow.",
              "explanationThai": "ในพื้นที่ร้อนชื้น mosquitos ที่แพร่โรคเติบโตได้ คำว่า Disease-causing … จึงตอบ mosquitoes",
              "paraphrasedVocabulary": "hot damp = tropical = mosquitoes"
            },
            {
              "number": 23,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "text",
              "exactPortion": "Part of the problem is, of course, the massive number of cars being driven, in addition to factories that run on coal power.",
              "explanationThai": "มลพิษมาจาก factories that run on coal power คำว่า … that burn a particular fuel จึงตอบ factories",
              "paraphrasedVocabulary": "burn fuel = run on coal = factories"
            },
            {
              "number": 24,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "text",
              "exactPortion": "The rapid industrialisation of some countries in recent years has also led to the cutting down of forests to allow for the expansion of big cities, which makes it even harder to fight the pollution with the fresh air tha",
              "explanationThai": "การขยายเมืองทำให้มี cutting down of forests คำว่า impact on nearby … จึงตอบ forests",
              "paraphrasedVocabulary": "impact on = cutting down = forests"
            },
            {
              "number": 25,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "text",
              "exactPortion": "It is an increasingly important area of study in a world where diseases like polio are re-emerging, respiratory diseases continue to spread, and malaria-prone areas are still fighting to find a better cure.",
              "explanationThai": "โรคอย่าง polio are re-emerging หลังเคยถูกกำจัด คำว่า … growing after being eradicated จึงตอบ polio",
              "paraphrasedVocabulary": "growing after eradicated = re-emerging = polio"
            },
            {
              "number": 26,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 2",
              "answerType": "text",
              "exactPortion": "Individuals working in the area of the geography of healthcare provision attempt to assess the levels of healthcare in the area (for instance, it may be very difficult for people to get medical attention because there is",
              "explanationThai": "ตัวอย่างมี a mountain between their village and the nearest hospital คำว่า barrier such as a … จึงตอบ mountain",
              "paraphrasedVocabulary": "barrier = mountain = ภูเขา"
            }
          ]
        }
      ],
          ...
          "questions": [
            {
              ...
              "answerType": "text",
              "exactPortion": "The first thing they discovered is that music triggers the production of dopamine – a chemical with a key role in setting people’s moods – by the neurons (nerve cells) in both the dorsal and ventral regions of the brain.",
              "explanationThai": "ดนตรี triggers the production of dopamine คำว่า substance called … จึงตอบ dopamine",
              "paraphrasedVocabulary": "substance = dopamine = โดปามีน"
            },
            {
              "number": 28,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "text",
              "exactPortion": "As these two regions have long been linked with the experience of pleasure, this finding isn’t particularly surprising.",
              "explanationThai": "ส่วนของสมอง linked with the experience of pleasure คำว่า associated with feeling … จึงตอบ pleasure",
              "paraphrasedVocabulary": "feeling = experience of = pleasure"
            },
            {
              "number": 29,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "text",
              "exactPortion": "What is rather more significant is the finding that the dopamine neurons in the caudate – a region of the brain involved in learning stimulus-response associations, and in anticipating food and other ‘reward’ stimuli – w",
              "explanationThai": "มี dopamine neurons in the caudate คำว่า area called the … จึงตอบ caudate",
              "paraphrasedVocabulary": "area called = caudate = caudate"
            },
            {
              "number": 30,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "When listening to our favourite songs, our body betrays all the symptoms of emotional arousal.",
              "explanationThai": "ปฏิกิริยาทางกายรุนแรง ข้อความที่เกี่ยวกับ \"our body betrays all the symptoms of emotional arousal\" ชี้ไปที่ตัวเลือก B มากที่สุด",
              "paraphrasedVocabulary": "emphasise = symptoms of emotional arousal = B"
            },
            {
              "number": 33,
              "prompt": "What view of the Montreal study does the writer express in the second paragraph?",
              "correctAnswer": "C",
              "acceptedAnswers": [
                "C"
              ],
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Because the scientists were combining methodologies (PET and fMRI), they were able to obtain an impressively exact and detailed portrait of music in the brain.",
              "explanationThai": "ข้อมูลละเอียดแม่นยำ ข้อความที่เกี่ยวกับ \"obtain an impressively exact and detailed portrait\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "view = impressively exact = C"
            },
            {
              "number": 34,
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "While earlier theories of music focused on the way a sound can refer to the real world of images and experiences – its ‘connotative’ meaning – Meyer argued that the emotions we find in music come from the unfolding event",
              "explanationThai": "โครงสร้างภายในเพลง ข้อความที่เกี่ยวกับ \"emotions we find in music come from the unfolding events of the music itself\" ชี้ไปที่ตัวเลือก D มากที่สุด",
              "paraphrasedVocabulary": "causes = unfolding events = D"
            },
            {
              "number": 37,
              ...
              "answerType": "multiple-choice",
              "exactPortion": "What is rather more significant is the finding that the dopamine neurons in the caudate – a region of the brain involved in learning stimulus-response associations, and in anticipating food and other ‘reward’ stimuli – w",
              "explanationThai": "กิจกรรม neuron ก่อนจุดสำคัญ ข้อความที่เกี่ยวกับ \"most active around 15 seconds before\" ชี้ไปที่ตัวเลือก F มากที่สุด",
              "paraphrasedVocabulary": "discovered = most active before = F"
            },
            {
              "number": 38,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Numerous studies, after all, have demonstrated that dopamine neurons quickly adapt to predictable rewards.",
              "explanationThai": "neuron ลดลงเมื่อคาดเดาได้ ข้อความที่เกี่ยวกับ \"dopamine neurons quickly adapt to predictable rewards\" ชี้ไปที่ตัวเลือก B มากที่สุด",
              "paraphrasedVocabulary": "predictable = adapt = B"
            },
            {
              "number": 39,
              ...
              "answerGroup": "Cambridge 12 Test 3 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Meyer dissected 50 measures (bars) of the masterpiece, showing how Beethoven begins with the clear statement of a rhythmic and harmonic pattern and then, in an ingenious tonal dance, carefully holds off repeating it.",
              "explanationThai": "เลื่อนให้สิ่งที่ผู้ฟังคาดหวัง ข้อความที่เกี่ยวกับ \"carefully holds off repeating it\" ชี้ไปที่ตัวเลือก E มากที่สุด",
              "paraphrasedVocabulary": "delays = holds off repeating = E"
            },
            {
              "number": 40,
              ...
              "answerType": "multiple-choice",
              "exactPortion": "While earlier theories of music focused on the way a sound can refer to the real world of images and experiences – its ‘connotative’ meaning – Meyer argued that the emotions we find in music come from the unfolding event",
              "explanationThai": "เชื่อมโยงภาพและเหตุการณ์จริง ข้อความที่เกี่ยวกับ \"music focused on the way a sound can refer to the real world of images\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "earlier theories = refer to real world = C"
            }
          ]
        }
      ],
  ...
  {
    "id": "cambridge-12-test4-passage1",
    "title": "Cambridge 12 Test 4 Passage 1 - The History of Glass",
    "category": "normal",
          ...
          "questions": [
            {
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "text",
              "exactPortion": "Historians have discovered that a type of natural glass – obsidian – formed in places such as the mouth of a volcano as a result of the intense heat of an eruption melting sand – was first used as tips for spears.",
              "explanationThai": "มนุษย์ยุคแรกใช้ obsidian ซึ่งเป็น a type of natural glass คำว่า material called … จึงตอบ obsidian",
              "paraphrasedVocabulary": "material = obsidian = ออบซิเดียน"
            },
            {
              "number": 2,
              ...
              "answerType": "text",
              "exactPortion": "Historians have discovered that a type of natural glass – obsidian – formed in places such as the mouth of a volcano as a result of the intense heat of an eruption melting sand – was first used as tips for spears.",
              "explanationThai": "obsidian ถูก used as tips for spears คำว่า … of their spears จึงตอบ spears",
              "paraphrasedVocabulary": "sharp points = tips for spears = spears"
            },
            {
              "number": 3,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "text",
              "exactPortion": "Archaeologists have even found evidence of man-made glass which dates back to 4000 BC; this took the form of glazes used for coating stone beads.",
              "explanationThai": "มีการ coating stone beads ด้วยแก้ว คำว่า … made of stone were covered in glass จึงตอบ beads",
              "paraphrasedVocabulary": "made of stone = stone beads = beads"
            },
            {
              "number": 4,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "text",
              "exactPortion": "The glass made during this time was highly coloured due to the impurities of the raw material.",
              "explanationThai": "แก้วยุคแรก highly coloured due to the impurities คำว่า coloured because of the … จึงตอบ impurities",
              "paraphrasedVocabulary": "coloured because = impurities = สิ่งเจือปน"
            },
            {
              "number": 5,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "text",
              "exactPortion": "However, they guarded the skills and technology required to make glass very closely, and it was not until their empire collapsed in 476 AD that glass-making knowledge became widespread throughout Europe and the Middle Ea",
              "explanationThai": "ชาวโรมัน guarded the skills จนกว่าจักรวรรลจะล่มสลายปี 476 คำว่า Only the … knew how จึงตอบ Romans",
              "paraphrasedVocabulary": "only = guarded skills until 476 = Romans"
            },
            {
              "number": 6,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "text",
              "exactPortion": "He attempted to counter the effect of clouding that sometimes occurred in blown glass by introducing lead to the raw materials used in the process.",
              "explanationThai": "Ravenscroft พัฒนาวิธี by introducing lead to the raw materials คำว่า using … จึงตอบ lead",
              "paraphrasedVocabulary": "using = introducing = lead = ตะกั่ว"
            },
            {
              "number": 7,
              ...
              "answerType": "text",
              "exactPortion": "He attempted to counter the effect of clouding that sometimes occurred in blown glass by introducing lead to the raw materials used in the process.",
              "explanationThai": "ตะกั่วช่วย counter the effect of clouding ในแก้วเป่า คำว่า avoid the occurrence of … จึงตอบ clouding",
              "paraphrasedVocabulary": "avoid = counter = clouding = ขุ่น"
            },
            {
              "number": 8,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "text",
              "exactPortion": "In Britain, the modern glass industry only really started to develop after the repeal of the Excise Act in 1845.",
              "explanationThai": "อุตสาหกรรมแก้วฟื้นหลัง repeal ของกฎภาษี (Excise Act) คำว่า laws concerning … จึงตอบ taxes",
              "paraphrasedVocabulary": "laws = Excise Act = taxes = ภาษี"
            },
            {
              "number": 9,
              "prompt": "HM",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "true-false-not-given",
              "exactPortion": "From 1887 onwards, glass making developed from traditional mouth-blowing to a semi-automatic process, after factory-owner HM Ashley introduced a machine capable of producing 200 bottles per hour in Castleford, Yorkshire, England – more than",
              "explanationThai": "บทความระบุว่า \"From 1887 onwards, glass making developed from traditional mouth-blowing to a semi-au…\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "HM → From 1887 onwards, glass making developed from traditio… = TRUE"
            },
            {
              "number": 10,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "true-false-not-given",
              "exactPortion": "It was not until 1500 BC, however, that the first hollow glass container was made by covering a sand core with a layer of molten glass.",
              "explanationThai": "บทความระบุว่า \"It was not until 1500 BC, however, that the first hollow glass container was made by …\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "michael owens hired = until however hollow = FALSE"
            },
            {
              "number": 11,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "true-false-not-given",
              "exactPortion": "From our earliest origins, man has been making use of glass.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"From our earliest origins, man has been making use of glass.\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "nowadays glass produced = earliest origins making = NOT GIVEN"
            },
            {
              "number": 12,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 1",
              "answerType": "true-false-not-given",
              "exactPortion": "Glass blowing became the most common way to make glass containers from the first century BC.",
              "explanationThai": "บทความระบุว่า \"Glass blowing became the most common way to make glass containers from the first cent…\" ซึ่งสอดคล้องกับข้อความในข้อ จึงตอบ TRUE",
              "paraphrasedVocabulary": "concern environment leading = glass blowing became = TRUE"
            },
            {
              "number": 13,
              ...
              "exactPortion": "It was not until 1500 BC, however, that the first hollow glass container was made by covering a sand core with a layer of molten glass.",
              "explanationThai": "บทความระบุว่า \"It was not until 1500 BC, however, that the first hollow glass container was made by …\" ซึ่งขัดกับข้อความในข้อ จึงตอบ FALSE",
              "paraphrasedVocabulary": "expensive produce recycled = until however hollow = FALSE"
            }
          ]
        }
      ],
  ...
  {
    "id": "cambridge-12-test4-passage2",
    "title": "Cambridge 12 Test 4 Passage 2 - Bring Back the Big Cats",
    "category": "normal",
          ...
          "questions": [
            {
              ...
              "answerType": "multiple-choice",
              "exactPortion": "it would bring forward the tassel-eared cat's estimated extinction date by roughly 5,000 years",
              "explanationThai": "อยู่ในอังกฤษนานกว่าที่คิด ข้อความที่เกี่ยวกับ \"estimated extinction date\" ชี้ไปที่ตัวเลือก D มากที่สุด",
              "paraphrasedVocabulary": "survived longer = extinction date brought forward = D"
            },
            {
              "number": 15,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "One of the most striking findings of modern ecology is that ecosystems without large predators behave in completely different ways from those that retain them.",
              "explanationThai": "เพิ่มความหลากหลายทางชีวภาพ ข้อความที่เกี่ยวกับ \"large predators behave in completely different ways\" ชี้ไปที่ตัวเลือก A มากที่สุด",
              "paraphrasedVocabulary": "increase biodiversity = creating niches = A"
            },
            {
              "number": 16,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "Conservationists are starting to accept that the old preservation-jar model is failing, even on its own terms.",
              "explanationThai": "แนวทางผิดพลาด ข้อความที่เกี่ยวกับ \"sought to prevent them from changing\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "misguided = preservation-jar = C"
            },
            {
              "number": 17,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "This policy would also greatly boost catches in the surrounding seas; the fishing industry’s insistence on scouring every inch of seabed, leaving no breeding reserves, could not be more damaging to its own interests.",
              "explanationThai": "ประโยชน์ต่อการประมง ข้อความที่เกี่ยวกับ \"greatly boost catches in the surrounding seas\" ชี้ไปที่ตัวเลือก A มากที่สุด",
              "paraphrasedVocabulary": "practical benefits = boost catches = A"
            },
            {
              "number": 18,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "One of the reasons why the enthusiasm for rewilding is spreading so quickly in Britain is that it helps to create a more inspiring vision than the green movement’s usual promise of ‘Follow us and the world will be slight",
              "explanationThai": "ข้อความเชิงบวกน่าดึงดูด ข้อความที่เกี่ยวกับ \"helps to create a more inspiring vision\" ชี้ไปที่ตัวเลือก C มากที่สุด",
              "paraphrasedVocabulary": "positive message = inspiring vision = C"
            },
            {
              "number": 19,
              ...
              "answerType": "multiple-choice",
              "exactPortion": "One of the reasons why the enthusiasm for rewilding is spreading so quickly in Britain is that it helps to create a more inspiring vision than the green movement’s usual promise of ‘Follow us and the world will be slight",
              "explanationThai": "มนุษย์ ข้อความที่เกี่ยวกับ \"no known instance of one preying on people\" ชี้ไปที่ตัวเลือก E มากที่สุด",
              "paraphrasedVocabulary": "in danger = preying on people (none) = humans = E"
            },
            {
              "number": 20,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "It is a specialist predator of roe deer, a species that has exploded in Britain in recent decades, holding back, by intensive browsing, attempts to re-establish forests.",
            ...
            },
            {
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "The lynx requires deep cover, and as such presents little risk to sheep and other livestock, which are supposed, as a condition of farm subsidies, to be kept out of the woods.",
              "explanationThai": "ปศุสัตว์ ข้อความที่เกี่ยวกับ \"little risk to sheep and other livestock\" ชี้ไปที่ตัวเลือก F มากที่สุด",
              "paraphrasedVocabulary": "livestock = farm animals = F"
            },
            {
              "number": 22,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "multiple-choice",
              "exactPortion": "The attempt to reintroduce this predator marries well with the aim of bringing forests back to parts of our bare and barren uplands.",
              "explanationThai": "ป่าไม้/ต้นไม้ ข้อความที่เกี่ยวกับ \"bringing forests back\" ชี้ไปที่ตัวเลือก A มากที่สุด",
              "paraphrasedVocabulary": "native = forests back = trees = A"
            },
            {
              "number": 23,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "yes-no-not-given",
              "exactPortion": "thusiasm for rewilding is spreading so quickly in Britain is that it helps to create a more inspiring vision than the green movement’s usual promise of ‘Follow us and the world will be slightly less awful than it would otherwise have been.’",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"thusiasm for rewilding is spreading so quickly in Britain is that it helps to create …\" จึงตอบ NO",
              "paraphrasedVocabulary": "britain become european = thusiasm rewilding spreading = NO"
            },
            {
              "number": 24,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "true-false-not-given",
              "exactPortion": "The European population has tripled since 1970 to roughly 10,000.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"The European population has tripled since 1970 to roughly 10,000.\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "european population growth = european population tripled = NOT GIVEN"
            },
            {
              "number": 25,
              "prompt": "Changes in",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "yes-no-not-given",
              "exactPortion": "As with wolves, bears, beavers, boar, bison, moose and many other species, the lynx has been able to spread as farming has left the hills and people discover that it is more lucrative to protect charismatic wildlife than to hunt it, as tour",
              "explanationThai": "มุมมองของผู้เขียนสอดคล้องกับข้อนี้ โดยอ้างอิงจาก \"As with wolves, bears, beavers, boar, bison, moose and many other species, the lynx h…\" จึงตอบ YES",
              "paraphrasedVocabulary": "changes = wolves bears beavers = YES"
            },
            {
              "number": 26,
              "prompt": "Species reintroduction has commercial",
              "correctAnswer": "YES",
              "acceptedAnswers": [
                "YES"
              ],
              "answerGroup": "Cambridge 12 Test 4 Passage 2",
              "answerType": "yes-no-not-given",
              "exactPortion": "Above all, it means bringing back missing species.",
              "explanationThai": "มุมมองของผู้เขียนสอดคล้องกับข้อนี้ โดยอ้างอิงจาก \"Above all, it means bringing back missing species.\" จึงตอบ YES",
              "paraphrasedVocabulary": "species reintroduction commercial = above means bringing = YES"
            }
          ]
        }
      ],
          ...
          "questions": [
            {
              ...
              "answerType": "multiple-choice",
              "exactPortion": "Following the 2008 financial meltdown, which resulted in a deeper and more prolonged period of economic downturn than anyone expected, the search for explanations in the many post-mortems of the crisis has meant blame ha",
              "explanationThai": "หลายหน่วยถูกกล่าวหา เนื้อหาย่อหน้าที่เกี่ยวกับ \"blame has been spread far and wide\" ตรงกับหัวข้อ iv มากที่สุด",
              "paraphrasedVocabulary": "external bodies = blame spread = iv"
            },
            {
              "number": 28,
              "prompt": "Heading Paragraph B",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "The knock-on effect of this scrutiny has been to make the governance of companies in general an issue of intense public debate and has significantly increased the pressures on, and the responsibilities of, directors.",
              "explanationThai": "ผลกระทบจากการถูกจับตา เนื้อหาย่อหน้าที่เกี่ยวกับ \"increased the pressures on, and the responsibilities of, directors\" ตรงกับหัวข้อ ii มากที่สุด",
              "paraphrasedVocabulary": "close examination = scrutiny = ii"
            },
            {
              "number": 29,
              "prompt": "Heading Paragraph C",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Often, board business is devolved to committees in order to cope with the workload, which may be more efficient but can mean that the board as a whole is less involved in fully addressing some of the most important issue",
              "explanationThai": "กรรมการอาจไม่ร่วมแก้ปัญหาสำคัญ เนื้อหาย่อหน้าที่เกี่ยวกับ \"the board as a whole is less involved in fully addressing\" ตรงกับหัวข้อ vi มากที่สุด",
              "paraphrasedVocabulary": "not all directors take part = less involved = vi"
            },
            {
              "number": 30,
              "prompt": "Heading Paragraph D",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "A radical solution, which may work for some very large companies whose businesses are extensive and complex, is the professional board, whose members would work up to three or four days a week, supported by their own ded",
              "explanationThai": "ข้อเสนอเปลี่ยนรูปแบบคณะกรรมการ เนื้อหาย่อหน้าที่เกี่ยวกับ \"the professional board, whose members would work up to three or four days a week\" ตรงกับหัวข้อ viii มากที่สุด",
              "paraphrasedVocabulary": "proposal = professional board = viii"
            },
            {
              "number": 31,
              "prompt": "Heading Paragraph E",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "One of the main criticisms of boards and their directors is that they do not focus sufficiently on longer-term matters of strategy, sustainability and governance, but instead concentrate too much on short-term financial ",
              "explanationThai": "มองไม่ไกลพอ เนื้อหาย่อหน้าที่เกี่ยวกับ \"do not focus sufficiently on longer-term matters\" ตรงกับหัวข้อ vii มากที่สุด",
              "paraphrasedVocabulary": "not far enough ahead = short-term focus = vii"
            },
            {
              "number": 32,
              "prompt": "Heading Paragraph F",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Compensation for chief executives has become a combat zone where pitched battles between investors, management and board members are fought, often behind closed doors but increasingly frequently in the full glare of pres",
              "explanationThai": "ข้อพิพาทเรื่องค่าตอบแทน เนื้อหาย่อหน้าที่เกี่ยวกับ \"Compensation for chief executives has become a combat zone\" ตรงกับหัวข้อ i มากที่สุด",
              "paraphrasedVocabulary": "disputes over financial arrangements = compensation battles = i"
            },
            {
              "number": 33,
              "prompt": "Heading Paragraph G",
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "multiple-choice",
              "exactPortion": "Boards of companies in all sectors will need to widen their perspective to encompass these issues and this may involve a realignment of corporate goals.",
              "explanationThai": "อาจต้องเปลี่ยนแปลงพื้นฐาน เนื้อหาย่อหน้าที่เกี่ยวกับ \"widen their perspective\" ตรงกับหัวข้อ iii มากที่สุด",
              "paraphrasedVocabulary": "fundamental change = realignment of goals = iii"
            },
            {
              "number": 34,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "yes-no-not-given",
              "exactPortion": "resulted in a deeper and more prolonged period of economic downturn than anyone expected, the search for explanations in the many post-mortems of the crisis has meant blame has been spread far and wide.",
              "explanationThai": "มุมมองของผู้เขียนสอดคล้องกับข้อนี้ โดยอ้างอิงจาก \"resulted in a deeper and more prolonged period of economic downturn than anyone expec…\" จึงตอบ YES",
              "paraphrasedVocabulary": "close scrutiny boards = resulted deeper prolonged = YES"
            },
            {
              "number": 35,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "true-false-not-given",
              "exactPortion": "Governments, regulators, central banks and auditors have all been in the frame.",
              "explanationThai": "บทความไม่ได้ให้ข้อมูลเพียงพอเกี่ยวกับประเด็นในข้อ (อ้างอิง: \"Governments, regulators, central banks and auditors have all been in the frame.\") จึงตอบ NOT GIVEN",
              "paraphrasedVocabulary": "banks mismanaged greater = governments regulators central = NOT GIVEN"
            },
            {
              "number": 36,
              "prompt": "Board meetings normally continue",
              "correctAnswer": "NO",
              "acceptedAnswers": [
                "NO"
              ],
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "yes-no-not-given",
              "exactPortion": "One of the main criticisms of boards and their directors is that they do not focus sufficiently on longer-term matters of strategy, sustainability and governance, but instead concentrate too much on short-term financial metrics.",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"One of the main criticisms of boards and their directors is that they do not focus su…\" จึงตอบ NO",
              "paraphrasedVocabulary": "board meetings normally = criticisms boards directors = NO"
            },
            {
              "number": 37,
              "prompt": "Using a committee structure would ensure board members",
              "correctAnswer": "NO",
              "acceptedAnswers": [
                "NO"
              ],
              ...
              "exactPortion": "One of the main criticisms of boards and their directors is that they do not focus sufficiently on longer-term matters of strategy, sustainability and governance, but instead concentrate too much on short-term financial metrics.",
              "explanationThai": "มุมมองของผู้เขียนขัดแย้งกับข้อนี้ โดยอ้างอิงจาก \"One of the main criticisms of boards and their directors is that they do not focus su…\" จึงตอบ NO",
              "paraphrasedVocabulary": "using committee structure = criticisms boards directors = NO"
            },
            {
              "number": 38,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "text",
              "exactPortion": "However, more professional and better-informed boards would have been particularly appropriate for banks where the executives had access to information that part-time non-executive directors lacked, leaving the latter un",
              "explanationThai": "กรรมการ part-time non-executive directors lacked ข้อมูล ทำให้ไม่เข้าใจธุรกิจ คำว่า lack of … จึงตอบ information",
              "paraphrasedVocabulary": "lack of = lacked = information"
            },
            {
              "number": 39,
              ...
              "answerType": "text",
              "exactPortion": "One of the main criticisms of boards and their directors is that they do not focus sufficiently on longer-term matters of strategy, sustainability and governance, but instead concentrate too much on short-term financial ",
              "explanationThai": "บอร์ด concentrate too much on short-term financial metrics คำว่า too much emphasis on … considerations จึงตอบ financial",
              "paraphrasedVocabulary": "considerations = financial metrics = financial"
            },
            {
              "number": 40,
              ...
              "answerGroup": "Cambridge 12 Test 4 Passage 3",
              "answerType": "text",
              "exactPortion": "Many would argue that this is in the interest of transparency and good governance as shareholders use their muscle in the area of pay to pressure boards to remove underperforming chief executives.",
              "explanationThai": "shareholders use their muscle ในเรื่องค่าตอบแทน CEO คำว่า accept the views of … จึงตอบ shareholders",
              "paraphrasedVocabulary": "accept views = shareholders use muscle = shareholders"
            }
          ]
        }
      ],
